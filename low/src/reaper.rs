...
impl Reaper {
        ...
        let mut pointers = unsafe {
            ReaperFunctionPointers {
                ...
                __mergesort: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(__mergesort)).as_ptr()),
                ),
                AddCustomizableMenu: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(AddCustomizableMenu)).as_ptr(),
                        ),
                ),
                ...
                AddMediaItemToTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(AddMediaItemToTrack)).as_ptr(),
                        ),
                ),
                ...
                AddProjectMarker2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(AddProjectMarker2)).as_ptr(),
                        ),
                ),
                AddRemoveReaScript: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(AddRemoveReaScript)).as_ptr(),
                        ),
                ),
                AddTakeToMediaItem: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(AddTakeToMediaItem)).as_ptr(),
                        ),
                ),
                ...
                APIExists: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(APIExists)).as_ptr()),
                ),
                APITest: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(APITest)).as_ptr()),
                ),
                ApplyNudge: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ApplyNudge)).as_ptr()),
                ),
                ArmCommand: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ArmCommand)).as_ptr()),
                ),
                Audio_Init: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Audio_Init)).as_ptr()),
                ),
                Audio_IsPreBuffer: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Audio_IsPreBuffer)).as_ptr(),
                        ),
                ),
                ...
                Audio_Quit: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Audio_Quit)).as_ptr()),
                ),
                ...
                AudioAccessorStateChanged: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(AudioAccessorStateChanged))
                                .as_ptr(),
                        ),
                ),
                AudioAccessorUpdate: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(AudioAccessorUpdate)).as_ptr(),
                        ),
                ),
                AudioAccessorValidateState: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(AudioAccessorValidateState))
                                .as_ptr(),
                        ),
                ),
                BypassFxAllTracks: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(BypassFxAllTracks)).as_ptr(),
                        ),
                ),
                ...
                CalculateNormalization: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CalculateNormalization))
                                .as_ptr(),
                        ),
                ),
                ...
                CalculatePeaksFloatSrcPtr: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CalculatePeaksFloatSrcPtr))
                                .as_ptr(),
                        ),
                ),
                ...
                ClearConsole: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ClearConsole)).as_ptr()),
                ),
                ...
                ColorToNative: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ColorToNative)).as_ptr()),
                ),
                ...
                CountEnvelopePoints: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CountEnvelopePoints)).as_ptr(),
                        ),
                ),
                ...
                CountProjectMarkers: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CountProjectMarkers)).as_ptr(),
                        ),
                ),
                CountSelectedMediaItems: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CountSelectedMediaItems))
                                .as_ptr(),
                        ),
                ),
                CountSelectedTracks: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CountSelectedTracks)).as_ptr(),
                        ),
                ),
                ...
                CountTakeEnvelopes: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CountTakeEnvelopes)).as_ptr(),
                        ),
                ),
                CountTakes: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountTakes)).as_ptr()),
                ),
                ...
                CountTempoTimeSigMarkers: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CountTempoTimeSigMarkers))
                                .as_ptr(),
                        ),
                ),
                CountTrackEnvelopes: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CountTrackEnvelopes)).as_ptr(),
                        ),
                ),
                ...
                CountTracks: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountTracks)).as_ptr()),
                ),
                ...
                CreateNewMIDIItemInProj: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CreateNewMIDIItemInProj))
                                .as_ptr(),
                        ),
                ),
                CreateTakeAudioAccessor: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CreateTakeAudioAccessor))
                                .as_ptr(),
                        ),
                ),
                CreateTrackAudioAccessor: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CreateTrackAudioAccessor))
                                .as_ptr(),
                        ),
                ),
                ...
                CSurf_GetTouchState: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_GetTouchState)).as_ptr(),
                        ),
                ),
                CSurf_GoEnd: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_GoEnd)).as_ptr()),
                ),
                CSurf_GoStart: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_GoStart)).as_ptr()),
                ),
                ...
                CSurf_OnArrow: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnArrow)).as_ptr()),
                ),
                CSurf_OnFwd: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnFwd)).as_ptr()),
                ),
                ...
                CSurf_OnInputMonitorChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnInputMonitorChange))
                                .as_ptr(),
                        ),
                ),
                CSurf_OnInputMonitorChangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnInputMonitorChangeEx))
                                .as_ptr(),
                        ),
                ),
                CSurf_OnMuteChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnMuteChange)).as_ptr(),
                        ),
                ),
                ...
                CSurf_OnOscControlMessage: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnOscControlMessage))
                                .as_ptr(),
                        ),
                ),
                CSurf_OnOscControlMessage2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnOscControlMessage2))
                                .as_ptr(),
                        ),
                ),
                CSurf_OnPanChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnPanChange)).as_ptr(),
                        ),
                ),
                CSurf_OnPanChangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnPanChangeEx)).as_ptr(),
                        ),
                ),
                CSurf_OnPause: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnPause)).as_ptr()),
                ),
                CSurf_OnPlay: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnPlay)).as_ptr()),
                ),
                CSurf_OnPlayRateChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnPlayRateChange))
                                .as_ptr(),
                        ),
                ),
                ...
                CSurf_OnRecArmChangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnRecArmChangeEx))
                                .as_ptr(),
                        ),
                ),
                ...
                CSurf_OnRecvVolumeChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnRecvVolumeChange))
                                .as_ptr(),
                        ),
                ),
                CSurf_OnRew: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnRew)).as_ptr()),
                ),
                ...
                CSurf_OnSelectedChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnSelectedChange))
                                .as_ptr(),
                        ),
                ),
                ...
                CSurf_OnSendVolumeChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnSendVolumeChange))
                                .as_ptr(),
                        ),
                ),
                CSurf_OnSoloChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnSoloChange)).as_ptr(),
                        ),
                ),
                ...
                CSurf_OnStop: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnStop)).as_ptr()),
                ),
                CSurf_OnTempoChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnTempoChange)).as_ptr(),
                        ),
                ),
                CSurf_OnTrackSelection: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnTrackSelection))
                                .as_ptr(),
                        ),
                ),
                ...
                CSurf_OnVolumeChangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnVolumeChangeEx))
                                .as_ptr(),
                        ),
                ),
                CSurf_OnWidthChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_OnWidthChange)).as_ptr(),
                        ),
                ),
                ...
                CSurf_OnZoom: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnZoom)).as_ptr()),
                ),
                ...
                CSurf_SetAutoMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_SetAutoMode)).as_ptr(),
                        ),
                ),
                CSurf_SetPlayState: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_SetPlayState)).as_ptr(),
                        ),
                ),
                ...
                CSurf_SetSurfacePan: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_SetSurfacePan)).as_ptr(),
                        ),
                ),
                CSurf_SetSurfaceRecArm: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_SetSurfaceRecArm))
                                .as_ptr(),
                        ),
                ),
                CSurf_SetSurfaceSelected: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_SetSurfaceSelected))
                                .as_ptr(),
                        ),
                ),
                ...
                CSurf_SetSurfaceVolume: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_SetSurfaceVolume))
                                .as_ptr(),
                        ),
                ),
                CSurf_SetTrackListChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_SetTrackListChange))
                                .as_ptr(),
                        ),
                ),
                CSurf_TrackFromID: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CSurf_TrackFromID)).as_ptr(),
                        ),
                ),
                ...
                DB2SLIDER: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DB2SLIDER)).as_ptr()),
                ),
                ...
                DeleteEnvelopePointRange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DeleteEnvelopePointRange))
                                .as_ptr(),
                        ),
                ),
                DeleteEnvelopePointRangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DeleteEnvelopePointRangeEx))
                                .as_ptr(),
                        ),
                ),
                ...
                DeleteProjectMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DeleteProjectMarker)).as_ptr(),
                        ),
                ),
                DeleteProjectMarkerByIndex: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DeleteProjectMarkerByIndex))
                                .as_ptr(),
                        ),
                ),
                ...
                DeleteTakeStretchMarkers: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DeleteTakeStretchMarkers))
                                .as_ptr(),
                        ),
                ),
                DeleteTempoTimeSigMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DeleteTempoTimeSigMarker))
                                .as_ptr(),
                        ),
                ),
                DeleteTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DeleteTrack)).as_ptr()),
                ),
                ...
                DestroyLocalOscHandler: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DestroyLocalOscHandler))
                                .as_ptr(),
                        ),
                ),
                DoActionShortcutDialog: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DoActionShortcutDialog))
                                .as_ptr(),
                        ),
                ),
                Dock_UpdateDockID: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Dock_UpdateDockID)).as_ptr(),
                        ),
                ),
                ...
                DockIsChildOfDock: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DockIsChildOfDock)).as_ptr(),
                        ),
                ),
                DockWindowActivate: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DockWindowActivate)).as_ptr(),
                        ),
                ),
                DockWindowAdd: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DockWindowAdd)).as_ptr()),
                ),
                ...
                DockWindowRefresh: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DockWindowRefresh)).as_ptr(),
                        ),
                ),
                DockWindowRefreshForHWND: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DockWindowRefreshForHWND))
                                .as_ptr(),
                        ),
                ),
                ...
                DuplicateCustomizableMenu: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(DuplicateCustomizableMenu))
                                .as_ptr(),
                        ),
                ),
                EditTempoTimeSigMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EditTempoTimeSigMarker))
                                .as_ptr(),
                        ),
                ),
                EnsureNotCompletelyOffscreen: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EnsureNotCompletelyOffscreen))
                                .as_ptr(),
                        ),
                ),
                ...
                EnumerateSubdirectories: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EnumerateSubdirectories))
                                .as_ptr(),
                        ),
                ),
                EnumInstalledFX: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EnumInstalledFX)).as_ptr(),
                        ),
                ),
                EnumPitchShiftModes: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EnumPitchShiftModes)).as_ptr(),
                        ),
                ),
                EnumPitchShiftSubModes: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EnumPitchShiftSubModes))
                                .as_ptr(),
                        ),
                ),
                EnumProjectMarkers: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EnumProjectMarkers)).as_ptr(),
                        ),
                ),
                EnumProjectMarkers2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EnumProjectMarkers2)).as_ptr(),
                        ),
                ),
                EnumProjectMarkers3: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EnumProjectMarkers3)).as_ptr(),
                        ),
                ),
                EnumProjects: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(EnumProjects)).as_ptr()),
                ),
                ...
                EnumRegionRenderMatrix: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EnumRegionRenderMatrix))
                                .as_ptr(),
                        ),
                ),
                EnumTrackMIDIProgramNames: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EnumTrackMIDIProgramNames))
                                .as_ptr(),
                        ),
                ),
                EnumTrackMIDIProgramNamesEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(EnumTrackMIDIProgramNamesEx))
                                .as_ptr(),
                        ),
                ),
                Envelope_Evaluate: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Envelope_Evaluate)).as_ptr(),
                        ),
                ),
                ...
                Envelope_GetParentTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Envelope_GetParentTake))
                                .as_ptr(),
                        ),
                ),
                Envelope_GetParentTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Envelope_GetParentTrack))
                                .as_ptr(),
                        ),
                ),
                Envelope_SortPoints: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Envelope_SortPoints)).as_ptr(),
                        ),
                ),
                ...
                ExecProcess: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ExecProcess)).as_ptr()),
                ),
                file_exists: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(file_exists)).as_ptr()),
                ),
                FindTempoTimeSigMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(FindTempoTimeSigMarker))
                                .as_ptr(),
                        ),
                ),
                ...
                format_timestr_len: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(format_timestr_len)).as_ptr(),
                        ),
                ),
                format_timestr_pos: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(format_timestr_pos)).as_ptr(),
                        ),
                ),
                FreeHeapPtr: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(FreeHeapPtr)).as_ptr()),
                ),
                genGuid: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(genGuid)).as_ptr()),
                ),
                ...
                get_ini_file: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(get_ini_file)).as_ptr()),
                ),
                get_midi_config_var: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(get_midi_config_var)).as_ptr(),
                        ),
                ),
                ...
                GetActiveTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetActiveTake)).as_ptr()),
                ),
                GetAllProjectPlayStates: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetAllProjectPlayStates))
                                .as_ptr(),
                        ),
                ),
                GetAppVersion: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetAppVersion)).as_ptr()),
                ),
                ...
                GetAudioAccessorEndTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetAudioAccessorEndTime))
                                .as_ptr(),
                        ),
                ),
                ...
                GetAudioAccessorSamples: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetAudioAccessorSamples))
                                .as_ptr(),
                        ),
                ),
                GetAudioAccessorStartTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetAudioAccessorStartTime))
                                .as_ptr(),
                        ),
                ),
                GetAudioDeviceInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetAudioDeviceInfo)).as_ptr(),
                        ),
                ),
                GetColorTheme: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetColorTheme)).as_ptr()),
                ),
                GetColorThemeStruct: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetColorThemeStruct)).as_ptr(),
                        ),
                ),
                GetConfigWantsDock: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetConfigWantsDock)).as_ptr(),
                        ),
                ),
                ...
                GetCurrentProjectInLoadSave: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetCurrentProjectInLoadSave))
                                .as_ptr(),
                        ),
                ),
                ...
                GetCursorContext2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetCursorContext2)).as_ptr(),
                        ),
                ),
                GetCursorPosition: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetCursorPosition)).as_ptr(),
                        ),
                ),
                GetCursorPositionEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetCursorPositionEx)).as_ptr(),
                        ),
                ),
                GetDisplayedMediaItemColor: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetDisplayedMediaItemColor))
                                .as_ptr(),
                        ),
                ),
                GetDisplayedMediaItemColor2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetDisplayedMediaItemColor2))
                                .as_ptr(),
                        ),
                ),
                ...
                GetEnvelopePointByTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetEnvelopePointByTime))
                                .as_ptr(),
                        ),
                ),
                GetEnvelopePointByTimeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetEnvelopePointByTimeEx))
                                .as_ptr(),
                        ),
                ),
                GetEnvelopePointEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetEnvelopePointEx)).as_ptr(),
                        ),
                ),
                GetEnvelopeScalingMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetEnvelopeScalingMode))
                                .as_ptr(),
                        ),
                ),
                ...
                GetEnvelopeUIState: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetEnvelopeUIState)).as_ptr(),
                        ),
                ),
                GetExePath: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetExePath)).as_ptr()),
                ),
                GetExtState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetExtState)).as_ptr()),
                ),
                GetFocusedFX: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetFocusedFX)).as_ptr()),
                ),
                GetFocusedFX2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetFocusedFX2)).as_ptr()),
                ),
                ...
                GetFXEnvelope: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetFXEnvelope)).as_ptr()),
                ),
                GetGlobalAutomationOverride: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetGlobalAutomationOverride))
                                .as_ptr(),
                        ),
                ),
                GetHZoomLevel: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetHZoomLevel)).as_ptr()),
                ),
                GetIconThemePointer: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetIconThemePointer)).as_ptr(),
                        ),
                ),
                GetIconThemePointerForDPI: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetIconThemePointerForDPI))
                                .as_ptr(),
                        ),
                ),
                GetIconThemeStruct: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetIconThemeStruct)).as_ptr(),
                        ),
                ),
                GetInputActivityLevel: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetInputActivityLevel))
                                .as_ptr(),
                        ),
                ),
                GetInputChannelName: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetInputChannelName)).as_ptr(),
                        ),
                ),
                ...
                GetItemEditingTime2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetItemEditingTime2)).as_ptr(),
                        ),
                ),
                ...
                GetItemStateChunk: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetItemStateChunk)).as_ptr(),
                        ),
                ),
                ...
                GetLastMarkerAndCurRegion: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetLastMarkerAndCurRegion))
                                .as_ptr(),
                        ),
                ),
                ...
                GetLastTouchedTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetLastTouchedTrack)).as_ptr(),
                        ),
                ),
                GetMainHwnd: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMainHwnd)).as_ptr()),
                ),
                GetMasterMuteSoloFlags: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMasterMuteSoloFlags))
                                .as_ptr(),
                        ),
                ),
                ...
                GetMasterTrackVisibility: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMasterTrackVisibility))
                                .as_ptr(),
                        ),
                ),
                ...
                GetMaxMidiOutputs: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMaxMidiOutputs)).as_ptr(),
                        ),
                ),
                ...
                GetMediaItem: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaItem)).as_ptr()),
                ),
                GetMediaItem_Track: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaItem_Track)).as_ptr(),
                        ),
                ),
                GetMediaItemInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaItemInfo_Value))
                                .as_ptr(),
                        ),
                ),
                ...
                GetMediaItemTake_Peaks: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaItemTake_Peaks))
                                .as_ptr(),
                        ),
                ),
                GetMediaItemTake_Source: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaItemTake_Source))
                                .as_ptr(),
                        ),
                ),
                GetMediaItemTake_Track: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaItemTake_Track))
                                .as_ptr(),
                        ),
                ),
                GetMediaItemTakeByGUID: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaItemTakeByGUID))
                                .as_ptr(),
                        ),
                ),
                GetMediaItemTakeInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaItemTakeInfo_Value))
                                .as_ptr(),
                        ),
                ),
                GetMediaItemTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaItemTrack)).as_ptr(),
                        ),
                ),
                GetMediaSourceFileName: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaSourceFileName))
                                .as_ptr(),
                        ),
                ),
                ...
                GetMediaSourceNumChannels: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaSourceNumChannels))
                                .as_ptr(),
                        ),
                ),
                ...
                GetMediaSourceSampleRate: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaSourceSampleRate))
                                .as_ptr(),
                        ),
                ),
                GetMediaSourceType: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaSourceType)).as_ptr(),
                        ),
                ),
                GetMediaTrackInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetMediaTrackInfo_Value))
                                .as_ptr(),
                        ),
                ),
                ...
                GetNumAudioInputs: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetNumAudioInputs)).as_ptr(),
                        ),
                ),
                GetNumAudioOutputs: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetNumAudioOutputs)).as_ptr(),
                        ),
                ),
                ...
                GetNumTakeMarkers: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetNumTakeMarkers)).as_ptr(),
                        ),
                ),
                GetNumTracks: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetNumTracks)).as_ptr()),
                ),
                GetOS: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetOS)).as_ptr()),
                ),
                ...
                GetPeakFileNameEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetPeakFileNameEx)).as_ptr(),
                        ),
                ),
                GetPeakFileNameEx2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetPeakFileNameEx2)).as_ptr(),
                        ),
                ),
                ...
                GetPlayPosition2Ex: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetPlayPosition2Ex)).as_ptr(),
                        ),
                ),
                GetPlayPositionEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetPlayPositionEx)).as_ptr(),
                        ),
                ),
                GetPlayState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetPlayState)).as_ptr()),
                ),
                ...
                GetPreferredDiskReadMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetPreferredDiskReadMode))
                                .as_ptr(),
                        ),
                ),
                GetPreferredDiskReadModePeak: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetPreferredDiskReadModePeak))
                                .as_ptr(),
                        ),
                ),
                GetPreferredDiskWriteMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetPreferredDiskWriteMode))
                                .as_ptr(),
                        ),
                ),
                ...
                GetProjectStateChangeCount: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetProjectStateChangeCount))
                                .as_ptr(),
                        ),
                ),
                ...
                GetProjectTimeSignature: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetProjectTimeSignature))
                                .as_ptr(),
                        ),
                ),
                GetProjectTimeSignature2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetProjectTimeSignature2))
                                .as_ptr(),
                        ),
                ),
                ...
                GetSelectedEnvelope: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSelectedEnvelope)).as_ptr(),
                        ),
                ),
                ...
                GetSelectedTrack2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSelectedTrack2)).as_ptr(),
                        ),
                ),
                GetSelectedTrackEnvelope: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSelectedTrackEnvelope))
                                .as_ptr(),
                        ),
                ),
                GetSet_ArrangeView2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSet_ArrangeView2)).as_ptr(),
                        ),
                ),
                ...
                GetSetAutomationItemInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetAutomationItemInfo))
                                .as_ptr(),
                        ),
                ),
                ...
                GetSetEnvelopeInfo_String: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetEnvelopeInfo_String))
                                .as_ptr(),
                        ),
                ),
                GetSetEnvelopeState: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetEnvelopeState)).as_ptr(),
                        ),
                ),
                ...
                GetSetMediaItemInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetMediaItemInfo)).as_ptr(),
                        ),
                ),
                GetSetMediaItemInfo_String: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetMediaItemInfo_String))
                                .as_ptr(),
                        ),
                ),
                GetSetMediaItemTakeInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetMediaItemTakeInfo))
                                .as_ptr(),
                        ),
                ),
                ...
                GetSetMediaTrackInfo_String: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetMediaTrackInfo_String))
                                .as_ptr(),
                        ),
                ),
                GetSetObjectState: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetObjectState)).as_ptr(),
                        ),
                ),
                GetSetObjectState2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetObjectState2)).as_ptr(),
                        ),
                ),
                GetSetProjectAuthor: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetProjectAuthor)).as_ptr(),
                        ),
                ),
                GetSetProjectGrid: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetProjectGrid)).as_ptr(),
                        ),
                ),
                GetSetProjectInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetProjectInfo)).as_ptr(),
                        ),
                ),
                GetSetProjectInfo_String: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetProjectInfo_String))
                                .as_ptr(),
                        ),
                ),
                ...
                GetSetTrackMIDISupportFile: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetTrackMIDISupportFile))
                                .as_ptr(),
                        ),
                ),
                GetSetTrackSendInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetTrackSendInfo)).as_ptr(),
                        ),
                ),
                GetSetTrackSendInfo_String: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetTrackSendInfo_String))
                                .as_ptr(),
                        ),
                ),
                ...
                GetSetTrackState2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSetTrackState2)).as_ptr(),
                        ),
                ),
                GetSubProjectFromSource: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetSubProjectFromSource))
                                .as_ptr(),
                        ),
                ),
                GetTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTake)).as_ptr()),
                ),
                ...
                GetTakeMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTakeMarker)).as_ptr()),
                ),
                GetTakeName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTakeName)).as_ptr()),
                ),
                GetTakeNumStretchMarkers: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTakeNumStretchMarkers))
                                .as_ptr(),
                        ),
                ),
                ...
                GetTakeStretchMarkerSlope: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTakeStretchMarkerSlope))
                                .as_ptr(),
                        ),
                ),
                GetTCPFXParm: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTCPFXParm)).as_ptr()),
                ),
                ...
                GetThemeColor: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetThemeColor)).as_ptr()),
                ),
                GetThingFromPoint: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetThingFromPoint)).as_ptr(),
                        ),
                ),
                ...
                GetToggleCommandState2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetToggleCommandState2))
                                .as_ptr(),
                        ),
                ),
                GetToggleCommandStateEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetToggleCommandStateEx))
                                .as_ptr(),
                        ),
                ),
                ...
                GetTouchedOrFocusedFX: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTouchedOrFocusedFX))
                                .as_ptr(),
                        ),
                ),
                GetTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrack)).as_ptr()),
                ),
                GetTrackAutomationMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackAutomationMode))
                                .as_ptr(),
                        ),
                ),
                GetTrackColor: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackColor)).as_ptr()),
                ),
                GetTrackDepth: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackDepth)).as_ptr()),
                ),
                ...
                GetTrackEnvelopeByChunkName: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackEnvelopeByChunkName))
                                .as_ptr(),
                        ),
                ),
                GetTrackEnvelopeByName: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackEnvelopeByName))
                                .as_ptr(),
                        ),
                ),
                GetTrackFromPoint: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackFromPoint)).as_ptr(),
                        ),
                ),
                GetTrackGUID: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackGUID)).as_ptr()),
                ),
                GetTrackInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackInfo)).as_ptr()),
                ),
                GetTrackMediaItem: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackMediaItem)).as_ptr(),
                        ),
                ),
                GetTrackMIDILyrics: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackMIDILyrics)).as_ptr(),
                        ),
                ),
                ...
                GetTrackMIDINoteNameEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackMIDINoteNameEx))
                                .as_ptr(),
                        ),
                ),
                ...
                GetTrackName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackName)).as_ptr()),
                ),
                ...
                GetTrackReceiveName: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackReceiveName)).as_ptr(),
                        ),
                ),
                ...
                GetTrackReceiveUIVolPan: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackReceiveUIVolPan))
                                .as_ptr(),
                        ),
                ),
                GetTrackSendInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackSendInfo_Value))
                                .as_ptr(),
                        ),
                ),
                ...
                GetTrackSendUIMute: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackSendUIMute)).as_ptr(),
                        ),
                ),
                ...
                GetTrackState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackState)).as_ptr()),
                ),
                GetTrackStateChunk: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetTrackStateChunk)).as_ptr(),
                        ),
                ),
                ...
                GetTrackUIPan: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackUIPan)).as_ptr()),
                ),
                ...
                GetUserFileNameForRead: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(GetUserFileNameForRead))
                                .as_ptr(),
                        ),
                ),
                GetUserInputs: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetUserInputs)).as_ptr()),
                ),
                GoToMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GoToMarker)).as_ptr()),
                ),
                GoToRegion: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GoToRegion)).as_ptr()),
                ),
                ...
                GSC_mainwnd: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GSC_mainwnd)).as_ptr()),
                ),
                guidToString: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(guidToString)).as_ptr()),
                ),
                HasExtState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(HasExtState)).as_ptr()),
                ),
                ...
                HasTrackMIDIProgramsEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(HasTrackMIDIProgramsEx))
                                .as_ptr(),
                        ),
                ),
                Help_Set: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Help_Set)).as_ptr()),
                ),
                ...
                InsertEnvelopePoint: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(InsertEnvelopePoint)).as_ptr(),
                        ),
                ),
                ...
                InsertMedia: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(InsertMedia)).as_ptr()),
                ),
                InsertMediaSection: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(InsertMediaSection)).as_ptr(),
                        ),
                ),
                ...
                IsInRealTimeAudio: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(IsInRealTimeAudio)).as_ptr(),
                        ),
                ),
                IsItemTakeActiveForPlayback: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(IsItemTakeActiveForPlayback))
                                .as_ptr(),
                        ),
                ),
                ...
                IsMediaItemSelected: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(IsMediaItemSelected)).as_ptr(),
                        ),
                ),
                ...
                IsREAPER: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(IsREAPER)).as_ptr()),
                ),
                ...
                joystick_enum: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(joystick_enum)).as_ptr()),
                ),
                ...
                joystick_getbuttonmask: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(joystick_getbuttonmask))
                                .as_ptr(),
                        ),
                ),
                ...
                kbd_formatKeyName: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(kbd_formatKeyName)).as_ptr(),
                        ),
                ),
                kbd_getCommandName: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(kbd_getCommandName)).as_ptr(),
                        ),
                ),
                kbd_getTextFromCmd: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(kbd_getTextFromCmd)).as_ptr(),
                        ),
                ),
                KBD_OnMainActionEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(KBD_OnMainActionEx)).as_ptr(),
                        ),
                ),
                ...
                kbd_ProcessActionsMenu: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(kbd_ProcessActionsMenu))
                                .as_ptr(),
                        ),
                ),
                kbd_processMidiEventActionEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(kbd_processMidiEventActionEx))
                                .as_ptr(),
                        ),
                ),
                kbd_reprocessMenu: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(kbd_reprocessMenu)).as_ptr(),
                        ),
                ),
                kbd_RunCommandThroughHooks: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(kbd_RunCommandThroughHooks))
                                .as_ptr(),
                        ),
                ),
                kbd_translateAccelerator: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(kbd_translateAccelerator))
                                .as_ptr(),
                        ),
                ),
                LICE__Destroy: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__Destroy)).as_ptr()),
                ),
                LICE__DestroyFont: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(LICE__DestroyFont)).as_ptr(),
                        ),
                ),
                ...
                LICE__GetBits: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__GetBits)).as_ptr()),
                ),
                LICE__GetDC: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__GetDC)).as_ptr()),
                ),
                ...
                LICE__resize: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__resize)).as_ptr()),
                ),
                ...
                LICE__SetFromHFont: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(LICE__SetFromHFont)).as_ptr(),
                        ),
                ),
                LICE__SetTextColor: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(LICE__SetTextColor)).as_ptr(),
                        ),
                ),
                LICE__SetTextCombineMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(LICE__SetTextCombineMode))
                                .as_ptr(),
                        ),
                ),
                LICE_Arc: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_Arc)).as_ptr()),
                ),
                LICE_Blit: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_Blit)).as_ptr()),
                ),
                LICE_Blur: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_Blur)).as_ptr()),
                ),
                LICE_BorderedRect: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(LICE_BorderedRect)).as_ptr(),
                        ),
                ),
                LICE_Circle: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_Circle)).as_ptr()),
                ),
                LICE_Clear: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_Clear)).as_ptr()),
                ),
                ...
                LICE_ClipLine: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_ClipLine)).as_ptr()),
                ),
                LICE_CombinePixels: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(LICE_CombinePixels)).as_ptr(),
                        ),
                ),
                LICE_Copy: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_Copy)).as_ptr()),
                ),
                LICE_CreateBitmap: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(LICE_CreateBitmap)).as_ptr(),
                        ),
                ),
                ...
                LICE_DrawChar: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_DrawChar)).as_ptr()),
                ),
                ...
                LICE_DrawRect: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_DrawRect)).as_ptr()),
                ),
                LICE_DrawText: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_DrawText)).as_ptr()),
                ),
                ...
                LICE_FillConvexPolygon: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(LICE_FillConvexPolygon))
                                .as_ptr(),
                        ),
                ),
                LICE_FillRect: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_FillRect)).as_ptr()),
                ),
                LICE_FillTrapezoid: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(LICE_FillTrapezoid)).as_ptr(),
                        ),
                ),
                LICE_FillTriangle: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(LICE_FillTriangle)).as_ptr(),
                        ),
                ),
                LICE_GetPixel: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_GetPixel)).as_ptr()),
                ),
                LICE_GradRect: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_GradRect)).as_ptr()),
                ),
                LICE_Line: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_Line)).as_ptr()),
                ),
                LICE_LineInt: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_LineInt)).as_ptr()),
                ),
                LICE_LoadPNG: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_LoadPNG)).as_ptr()),
                ),
                LICE_LoadPNGFromResource: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(LICE_LoadPNGFromResource))
                                .as_ptr(),
                        ),
                ),
                ...
                LICE_PutPixel: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_PutPixel)).as_ptr()),
                ),
                ...
                Loop_OnArrow: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Loop_OnArrow)).as_ptr()),
                ),
                ...
                Main_SaveProjectEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Main_SaveProjectEx)).as_ptr(),
                        ),
                ),
                Main_UpdateLoopInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Main_UpdateLoopInfo)).as_ptr(),
                        ),
                ),
                ...
                MarkTrackItemsDirty: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MarkTrackItemsDirty)).as_ptr(),
                        ),
                ),
                Master_GetPlayRate: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Master_GetPlayRate)).as_ptr(),
                        ),
                ),
                Master_GetPlayRateAtTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Master_GetPlayRateAtTime))
                                .as_ptr(),
                        ),
                ),
                ...
                Master_NormalizePlayRate: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Master_NormalizePlayRate))
                                .as_ptr(),
                        ),
                ),
                ...
                MediaItemDescendsFromTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MediaItemDescendsFromTrack))
                                .as_ptr(),
                        ),
                ),
                Menu_GetHash: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Menu_GetHash)).as_ptr()),
                ),
                ...
                MIDI_DeleteCC: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_DeleteCC)).as_ptr()),
                ),
                ...
                MIDI_DeleteTextSysexEvt: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_DeleteTextSysexEvt))
                                .as_ptr(),
                        ),
                ),
                ...
                MIDI_EnumSelNotes: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_EnumSelNotes)).as_ptr(),
                        ),
                ),
                MIDI_EnumSelTextSysexEvts: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_EnumSelTextSysexEvts))
                                .as_ptr(),
                        ),
                ),
                ...
                MIDI_eventlist_Destroy: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_eventlist_Destroy))
                                .as_ptr(),
                        ),
                ),
                ...
                MIDI_GetCC: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetCC)).as_ptr()),
                ),
                ...
                MIDI_GetEvt: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetEvt)).as_ptr()),
                ),
                MIDI_GetGrid: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetGrid)).as_ptr()),
                ),
                MIDI_GetHash: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetHash)).as_ptr()),
                ),
                MIDI_GetNote: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetNote)).as_ptr()),
                ),
                MIDI_GetPPQPos_EndOfMeasure: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_GetPPQPos_EndOfMeasure))
                                .as_ptr(),
                        ),
                ),
                ...
                MIDI_GetPPQPosFromProjQN: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_GetPPQPosFromProjQN))
                                .as_ptr(),
                        ),
                ),
                MIDI_GetPPQPosFromProjTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_GetPPQPosFromProjTime))
                                .as_ptr(),
                        ),
                ),
                MIDI_GetProjQNFromPPQPos: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_GetProjQNFromPPQPos))
                                .as_ptr(),
                        ),
                ),
                MIDI_GetProjTimeFromPPQPos: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_GetProjTimeFromPPQPos))
                                .as_ptr(),
                        ),
                ),
                MIDI_GetRecentInputEvent: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_GetRecentInputEvent))
                                .as_ptr(),
                        ),
                ),
                MIDI_GetScale: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetScale)).as_ptr()),
                ),
                ...
                MIDI_GetTrackHash: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_GetTrackHash)).as_ptr(),
                        ),
                ),
                midi_init: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(midi_init)).as_ptr()),
                ),
                MIDI_InsertCC: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_InsertCC)).as_ptr()),
                ),
                ...
                midi_reinit: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(midi_reinit)).as_ptr()),
                ),
                ...
                MIDI_SetCC: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_SetCC)).as_ptr()),
                ),
                ...
                MIDI_SetEvt: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_SetEvt)).as_ptr()),
                ),
                MIDI_SetItemExtents: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDI_SetItemExtents)).as_ptr(),
                        ),
                ),
                MIDI_SetNote: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_SetNote)).as_ptr()),
                ),
                ...
                MIDI_Sort: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_Sort)).as_ptr()),
                ),
                ...
                MIDIEditor_GetMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDIEditor_GetMode)).as_ptr(),
                        ),
                ),
                MIDIEditor_GetSetting_int: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDIEditor_GetSetting_int))
                                .as_ptr(),
                        ),
                ),
                MIDIEditor_GetSetting_str: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDIEditor_GetSetting_str))
                                .as_ptr(),
                        ),
                ),
                MIDIEditor_GetTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDIEditor_GetTake)).as_ptr(),
                        ),
                ),
                ...
                MIDIEditor_SetSetting_int: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDIEditor_SetSetting_int))
                                .as_ptr(),
                        ),
                ),
                MIDIEditorFlagsForTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(MIDIEditorFlagsForTrack))
                                .as_ptr(),
                        ),
                ),
                mkpanstr: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(mkpanstr)).as_ptr()),
                ),
                mkvolpanstr: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(mkvolpanstr)).as_ptr()),
                ),
                mkvolstr: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(mkvolstr)).as_ptr()),
                ),
                ...
                MuteAllTracks: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MuteAllTracks)).as_ptr()),
                ),
                ...
                NamedCommandLookup: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(NamedCommandLookup)).as_ptr(),
                        ),
                ),
                OnPauseButton: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(OnPauseButton)).as_ptr()),
                ),
                ...
                OnPlayButton: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(OnPlayButton)).as_ptr()),
                ),
                ...
                OnStopButton: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(OnStopButton)).as_ptr()),
                ),
                ...
                OpenColorThemeFile: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(OpenColorThemeFile)).as_ptr(),
                        ),
                ),
                OpenMediaExplorer: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(OpenMediaExplorer)).as_ptr(),
                        ),
                ),
                ...
                parse_timestr: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(parse_timestr)).as_ptr()),
                ),
                parse_timestr_len: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(parse_timestr_len)).as_ptr(),
                        ),
                ),
                parse_timestr_pos: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(parse_timestr_pos)).as_ptr(),
                        ),
                ),
                parsepanstr: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(parsepanstr)).as_ptr()),
                ),
                ...
                PCM_Sink_CreateEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PCM_Sink_CreateEx)).as_ptr(),
                        ),
                ),
                PCM_Sink_CreateMIDIFile: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PCM_Sink_CreateMIDIFile))
                                .as_ptr(),
                        ),
                ),
                PCM_Sink_CreateMIDIFileEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PCM_Sink_CreateMIDIFileEx))
                                .as_ptr(),
                        ),
                ),
                PCM_Sink_Enum: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PCM_Sink_Enum)).as_ptr()),
                ),
                ...
                PCM_Sink_ShowConfig: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PCM_Sink_ShowConfig)).as_ptr(),
                        ),
                ),
                ...
                PCM_Source_CreateFromFile: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PCM_Source_CreateFromFile))
                                .as_ptr(),
                        ),
                ),
                PCM_Source_CreateFromFileEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PCM_Source_CreateFromFileEx))
                                .as_ptr(),
                        ),
                ),
                PCM_Source_CreateFromSimple: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PCM_Source_CreateFromSimple))
                                .as_ptr(),
                        ),
                ),
                PCM_Source_CreateFromType: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PCM_Source_CreateFromType))
                                .as_ptr(),
                        ),
                ),
                PCM_Source_Destroy: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PCM_Source_Destroy)).as_ptr(),
                        ),
                ),
                PCM_Source_GetPeaks: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PCM_Source_GetPeaks)).as_ptr(),
                        ),
                ),
                PCM_Source_GetSectionInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PCM_Source_GetSectionInfo))
                                .as_ptr(),
                        ),
                ),
                ...
                PeakBuild_CreateEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PeakBuild_CreateEx)).as_ptr(),
                        ),
                ),
                ...
                PlayPreview: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PlayPreview)).as_ptr()),
                ),
                PlayPreviewEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PlayPreviewEx)).as_ptr()),
                ),
                ...
                PlayTrackPreview2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PlayTrackPreview2)).as_ptr(),
                        ),
                ),
                PlayTrackPreview2Ex: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PlayTrackPreview2Ex)).as_ptr(),
                        ),
                ),
                plugin_getapi: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(plugin_getapi)).as_ptr()),
                ),
                ...
                PluginWantsAlwaysRunFx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(PluginWantsAlwaysRunFx))
                                .as_ptr(),
                        ),
                ),
                ...
                projectconfig_var_addr: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(projectconfig_var_addr))
                                .as_ptr(),
                        ),
                ),
                projectconfig_var_getoffs: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(projectconfig_var_getoffs))
                                .as_ptr(),
                        ),
                ),
                ...
                realloc_cmd_clear: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(realloc_cmd_clear)).as_ptr(),
                        ),
                ),
                ...
                realloc_cmd_register_buf: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(realloc_cmd_register_buf))
                                .as_ptr(),
                        ),
                ),
                ReaperGetPitchShiftAPI: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(ReaperGetPitchShiftAPI))
                                .as_ptr(),
                        ),
                ),
                ...
                RecursiveCreateDirectory: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(RecursiveCreateDirectory))
                                .as_ptr(),
                        ),
                ),
                reduce_open_files: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(reduce_open_files)).as_ptr(),
                        ),
                ),
                ...
                relative_fn: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(relative_fn)).as_ptr()),
                ),
                ...
                RenderFileSection: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(RenderFileSection)).as_ptr(),
                        ),
                ),
                ...
                Resample_EnumModes: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Resample_EnumModes)).as_ptr(),
                        ),
                ),
                ...
                resolve_fn: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(resolve_fn)).as_ptr()),
                ),
                resolve_fn2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(resolve_fn2)).as_ptr()),
                ),
                ...
                ReverseNamedCommandLookup: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(ReverseNamedCommandLookup))
                                .as_ptr(),
                        ),
                ),
                ...
                ScaleToEnvelopeMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(ScaleToEnvelopeMode)).as_ptr(),
                        ),
                ),
                screenset_register: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(screenset_register)).as_ptr(),
                        ),
                ),
                ...
                screenset_unregisterByParam: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(screenset_unregisterByParam))
                                .as_ptr(),
                        ),
                ),
                screenset_updateLastFocus: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(screenset_updateLastFocus))
                                .as_ptr(),
                        ),
                ),
                SectionFromUniqueID: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SectionFromUniqueID)).as_ptr(),
                        ),
                ),
                SelectAllMediaItems: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SelectAllMediaItems)).as_ptr(),
                        ),
                ),
                ...
                SendLocalOscMessage: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SendLocalOscMessage)).as_ptr(),
                        ),
                ),
                SendMIDIMessageToHardware: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SendMIDIMessageToHardware))
                                .as_ptr(),
                        ),
                ),
                SetActiveTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetActiveTake)).as_ptr()),
                ),
                SetAutomationMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetAutomationMode)).as_ptr(),
                        ),
                ),
                SetCurrentBPM: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetCurrentBPM)).as_ptr()),
                ),
                ...
                SetEditCurPos: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetEditCurPos)).as_ptr()),
                ),
                ...
                SetEnvelopePointEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetEnvelopePointEx)).as_ptr(),
                        ),
                ),
                ...
                SetExtState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetExtState)).as_ptr()),
                ),
                SetGlobalAutomationOverride: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetGlobalAutomationOverride))
                                .as_ptr(),
                        ),
                ),
                SetItemStateChunk: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetItemStateChunk)).as_ptr(),
                        ),
                ),
                SetMasterTrackVisibility: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetMasterTrackVisibility))
                                .as_ptr(),
                        ),
                ),
                SetMediaItemInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetMediaItemInfo_Value))
                                .as_ptr(),
                        ),
                ),
                SetMediaItemLength: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetMediaItemLength)).as_ptr(),
                        ),
                ),
                ...
                SetMediaItemTake_Source: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetMediaItemTake_Source))
                                .as_ptr(),
                        ),
                ),
                SetMediaItemTakeInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetMediaItemTakeInfo_Value))
                                .as_ptr(),
                        ),
                ),
                SetMediaTrackInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetMediaTrackInfo_Value))
                                .as_ptr(),
                        ),
                ),
                SetMIDIEditorGrid: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetMIDIEditorGrid)).as_ptr(),
                        ),
                ),
                ...
                SetProjectMarker2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetProjectMarker2)).as_ptr(),
                        ),
                ),
                SetProjectMarker3: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetProjectMarker3)).as_ptr(),
                        ),
                ),
                SetProjectMarker4: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetProjectMarker4)).as_ptr(),
                        ),
                ),
                SetProjectMarkerByIndex: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetProjectMarkerByIndex))
                                .as_ptr(),
                        ),
                ),
                SetProjectMarkerByIndex2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetProjectMarkerByIndex2))
                                .as_ptr(),
                        ),
                ),
                ...
                SetRenderLastError: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetRenderLastError)).as_ptr(),
                        ),
                ),
                SetTakeMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetTakeMarker)).as_ptr()),
                ),
                ...
                SetTakeStretchMarkerSlope: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetTakeStretchMarkerSlope))
                                .as_ptr(),
                        ),
                ),
                ...
                SetThemeColor: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetThemeColor)).as_ptr()),
                ),
                ...
                SetTrackAutomationMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetTrackAutomationMode))
                                .as_ptr(),
                        ),
                ),
                SetTrackColor: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetTrackColor)).as_ptr()),
                ),
                SetTrackMIDILyrics: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetTrackMIDILyrics)).as_ptr(),
                        ),
                ),
                ...
                SetTrackMIDINoteNameEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetTrackMIDINoteNameEx))
                                .as_ptr(),
                        ),
                ),
                ...
                SetTrackSendInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetTrackSendInfo_Value))
                                .as_ptr(),
                        ),
                ),
                SetTrackSendUIPan: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetTrackSendUIPan)).as_ptr(),
                        ),
                ),
                SetTrackSendUIVol: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetTrackSendUIVol)).as_ptr(),
                        ),
                ),
                SetTrackStateChunk: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetTrackStateChunk)).as_ptr(),
                        ),
                ),
                SetTrackUIInputMonitor: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetTrackUIInputMonitor))
                                .as_ptr(),
                        ),
                ),
                ...
                SetTrackUIPan: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetTrackUIPan)).as_ptr()),
                ),
                SetTrackUIPolarity: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(SetTrackUIPolarity)).as_ptr(),
                        ),
                ),
                ...
                ShowPopupMenu: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ShowPopupMenu)).as_ptr()),
                ),
                SLIDER2DB: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SLIDER2DB)).as_ptr()),
                ),
                SnapToGrid: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SnapToGrid)).as_ptr()),
                ),
                SoloAllTracks: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SoloAllTracks)).as_ptr()),
                ),
                Splash_GetWnd: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Splash_GetWnd)).as_ptr()),
                ),
                ...
                StopPreview: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(StopPreview)).as_ptr()),
                ),
                ...
                StopTrackPreview2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(StopTrackPreview2)).as_ptr(),
                        ),
                ),
                stringToGuid: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(stringToGuid)).as_ptr()),
                ),
                ...
                TakeFX_CopyToTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_CopyToTake)).as_ptr(),
                        ),
                ),
                TakeFX_CopyToTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_CopyToTrack)).as_ptr(),
                        ),
                ),
                TakeFX_Delete: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_Delete)).as_ptr()),
                ),
                TakeFX_EndParamEdit: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_EndParamEdit)).as_ptr(),
                        ),
                ),
                TakeFX_FormatParamValue: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_FormatParamValue))
                                .as_ptr(),
                        ),
                ),
                ...
                TakeFX_GetChainVisible: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetChainVisible))
                                .as_ptr(),
                        ),
                ),
                ...
                TakeFX_GetEnabled: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetEnabled)).as_ptr(),
                        ),
                ),
                TakeFX_GetEnvelope: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetEnvelope)).as_ptr(),
                        ),
                ),
                TakeFX_GetFloatingWindow: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetFloatingWindow))
                                .as_ptr(),
                        ),
                ),
                ...
                TakeFX_GetNamedConfigParm: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetNamedConfigParm))
                                .as_ptr(),
                        ),
                ),
                TakeFX_GetNumParams: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetNumParams)).as_ptr(),
                        ),
                ),
                TakeFX_GetOffline: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetOffline)).as_ptr(),
                        ),
                ),
                ...
                TakeFX_GetParameterStepSizes: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetParameterStepSizes))
                                .as_ptr(),
                        ),
                ),
                TakeFX_GetParamEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetParamEx)).as_ptr(),
                        ),
                ),
                TakeFX_GetParamFromIdent: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetParamFromIdent))
                                .as_ptr(),
                        ),
                ),
                ...
                TakeFX_GetParamName: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetParamName)).as_ptr(),
                        ),
                ),
                TakeFX_GetParamNormalized: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetParamNormalized))
                                .as_ptr(),
                        ),
                ),
                ...
                TakeFX_GetUserPresetFilename: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_GetUserPresetFilename))
                                .as_ptr(),
                        ),
                ),
                TakeFX_NavigatePresets: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_NavigatePresets))
                                .as_ptr(),
                        ),
                ),
                TakeFX_SetEnabled: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_SetEnabled)).as_ptr(),
                        ),
                ),
                TakeFX_SetNamedConfigParm: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_SetNamedConfigParm))
                                .as_ptr(),
                        ),
                ),
                TakeFX_SetOffline: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_SetOffline)).as_ptr(),
                        ),
                ),
                ...
                TakeFX_SetParamNormalized: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_SetParamNormalized))
                                .as_ptr(),
                        ),
                ),
                ...
                TakeFX_SetPresetByIndex: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TakeFX_SetPresetByIndex))
                                .as_ptr(),
                        ),
                ),
                TakeFX_Show: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_Show)).as_ptr()),
                ),
                TakeIsMIDI: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeIsMIDI)).as_ptr()),
                ),
                ...
                ThemeLayout_GetParameter: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(ThemeLayout_GetParameter))
                                .as_ptr(),
                        ),
                ),
                ThemeLayout_RefreshAll: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(ThemeLayout_RefreshAll))
                                .as_ptr(),
                        ),
                ),
                ...
                ThemeLayout_SetParameter: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(ThemeLayout_SetParameter))
                                .as_ptr(),
                        ),
                ),
                time_precise: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(time_precise)).as_ptr()),
                ),
                ...
                TimeMap2_GetDividedBpmAtTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TimeMap2_GetDividedBpmAtTime))
                                .as_ptr(),
                        ),
                ),
                TimeMap2_GetNextChangeTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TimeMap2_GetNextChangeTime))
                                .as_ptr(),
                        ),
                ),
                TimeMap2_QNToTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TimeMap2_QNToTime)).as_ptr(),
                        ),
                ),
                ...
                TimeMap2_timeToQN: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TimeMap2_timeToQN)).as_ptr(),
                        ),
                ),
                ...
                TimeMap_GetDividedBpmAtTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TimeMap_GetDividedBpmAtTime))
                                .as_ptr(),
                        ),
                ),
                TimeMap_GetMeasureInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TimeMap_GetMeasureInfo))
                                .as_ptr(),
                        ),
                ),
                TimeMap_GetMetronomePattern: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TimeMap_GetMetronomePattern))
                                .as_ptr(),
                        ),
                ),
                TimeMap_GetTimeSigAtTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TimeMap_GetTimeSigAtTime))
                                .as_ptr(),
                        ),
                ),
                ...
                Track_GetPeakHoldDB: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Track_GetPeakHoldDB)).as_ptr(),
                        ),
                ),
                Track_GetPeakInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Track_GetPeakInfo)).as_ptr(),
                        ),
                ),
                TrackCtl_SetToolTip: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackCtl_SetToolTip)).as_ptr(),
                        ),
                ),
                TrackFX_AddByName: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_AddByName)).as_ptr(),
                        ),
                ),
                TrackFX_CopyToTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_CopyToTake)).as_ptr(),
                        ),
                ),
                TrackFX_CopyToTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_CopyToTrack)).as_ptr(),
                        ),
                ),
                ...
                TrackFX_FormatParamValue: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_FormatParamValue))
                                .as_ptr(),
                        ),
                ),
                ...
                TrackFX_GetByName: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetByName)).as_ptr(),
                        ),
                ),
                TrackFX_GetChainVisible: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetChainVisible))
                                .as_ptr(),
                        ),
                ),
                ...
                TrackFX_GetEnabled: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetEnabled)).as_ptr(),
                        ),
                ),
                TrackFX_GetEQ: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetEQ)).as_ptr()),
                ),
                TrackFX_GetEQBandEnabled: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetEQBandEnabled))
                                .as_ptr(),
                        ),
                ),
                TrackFX_GetEQParam: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetEQParam)).as_ptr(),
                        ),
                ),
                TrackFX_GetFloatingWindow: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetFloatingWindow))
                                .as_ptr(),
                        ),
                ),
                ...
                TrackFX_GetFXGUID: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetFXGUID)).as_ptr(),
                        ),
                ),
                TrackFX_GetFXName: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetFXName)).as_ptr(),
                        ),
                ),
                ...
                TrackFX_GetIOSize: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetIOSize)).as_ptr(),
                        ),
                ),
                TrackFX_GetNamedConfigParm: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetNamedConfigParm))
                                .as_ptr(),
                        ),
                ),
                ...
                TrackFX_GetOffline: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetOffline)).as_ptr(),
                        ),
                ),
                ...
                TrackFX_GetParamEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetParamEx)).as_ptr(),
                        ),
                ),
                TrackFX_GetParamFromIdent: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetParamFromIdent))
                                .as_ptr(),
                        ),
                ),
                ...
                TrackFX_GetParamNormalized: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetParamNormalized))
                                .as_ptr(),
                        ),
                ),
                TrackFX_GetPinMappings: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetPinMappings))
                                .as_ptr(),
                        ),
                ),
                TrackFX_GetPreset: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetPreset)).as_ptr(),
                        ),
                ),
                TrackFX_GetPresetIndex: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetPresetIndex))
                                .as_ptr(),
                        ),
                ),
                TrackFX_GetRecChainVisible: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetRecChainVisible))
                                .as_ptr(),
                        ),
                ),
                TrackFX_GetRecCount: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_GetRecCount)).as_ptr(),
                        ),
                ),
                ...
                TrackFX_NavigatePresets: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_NavigatePresets))
                                .as_ptr(),
                        ),
                ),
                TrackFX_SetEnabled: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_SetEnabled)).as_ptr(),
                        ),
                ),
                TrackFX_SetEQBandEnabled: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_SetEQBandEnabled))
                                .as_ptr(),
                        ),
                ),
                TrackFX_SetEQParam: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_SetEQParam)).as_ptr(),
                        ),
                ),
                TrackFX_SetNamedConfigParm: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_SetNamedConfigParm))
                                .as_ptr(),
                        ),
                ),
                TrackFX_SetOffline: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_SetOffline)).as_ptr(),
                        ),
                ),
                ...
                TrackFX_SetParamNormalized: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_SetParamNormalized))
                                .as_ptr(),
                        ),
                ),
                TrackFX_SetPinMappings: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_SetPinMappings))
                                .as_ptr(),
                        ),
                ),
                TrackFX_SetPreset: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_SetPreset)).as_ptr(),
                        ),
                ),
                TrackFX_SetPresetByIndex: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackFX_SetPresetByIndex))
                                .as_ptr(),
                        ),
                ),
                TrackFX_Show: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_Show)).as_ptr()),
                ),
                TrackList_AdjustWindows: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(TrackList_AdjustWindows))
                                .as_ptr(),
                        ),
                ),
                ...
                Undo_CanRedo2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_CanRedo2)).as_ptr()),
                ),
                Undo_CanUndo2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_CanUndo2)).as_ptr()),
                ),
                Undo_DoRedo2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_DoRedo2)).as_ptr()),
                ),
                Undo_DoUndo2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_DoUndo2)).as_ptr()),
                ),
                Undo_EndBlock: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_EndBlock)).as_ptr()),
                ),
                ...
                Undo_OnStateChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Undo_OnStateChange)).as_ptr(),
                        ),
                ),
                Undo_OnStateChange2: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Undo_OnStateChange2)).as_ptr(),
                        ),
                ),
                Undo_OnStateChange_Item: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(Undo_OnStateChange_Item))
                                .as_ptr(),
                        ),
                ),
                ...
                UpdateArrange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(UpdateArrange)).as_ptr()),
                ),
                UpdateItemInProject: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(UpdateItemInProject)).as_ptr(),
                        ),
                ),
                UpdateItemLanes: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(UpdateItemLanes)).as_ptr(),
                        ),
                ),
                ...
                ValidatePtr: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ValidatePtr)).as_ptr()),
                ),
                ValidatePtr2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ValidatePtr2)).as_ptr()),
                ),
                ViewPrefs: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ViewPrefs)).as_ptr()),
                ),
                WDL_VirtualWnd_ScaledBlitBG: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(WDL_VirtualWnd_ScaledBlitBG))
                                .as_ptr(),
                        ),
                ),
                GetMidiInput: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMidiInput)).as_ptr()),
                ),
                GetMidiOutput: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMidiOutput)).as_ptr()),
                ),
                ...
                UninitializeCoolSB: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(UninitializeCoolSB)).as_ptr(),
                        ),
                ),
                CoolSB_SetMinThumbSize: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CoolSB_SetMinThumbSize))
                                .as_ptr(),
                        ),
                ),
                ...
                CoolSB_SetScrollPos: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CoolSB_SetScrollPos)).as_ptr(),
                        ),
                ),
                ...
                CoolSB_SetResizingThumb: std::mem::transmute(
                    plugin_context
                        .GetFunc(
                            c_str_macro::c_str!(stringify!(CoolSB_SetResizingThumb))
                                .as_ptr(),
                        ),
                ),
    ...
    pub unsafe fn AddTempoTimeSigMarker(
        ...
        match self.pointers.AddTempoTimeSigMarker {
            ...
            Some(f) => {
                f(proj, timepos, bpm, timesig_num, timesig_denom, lineartempochange)
            }
        }
    }
    pub fn adjustZoom(
    ...
    pub unsafe fn ApplyNudge(
        ...
        match self.pointers.ApplyNudge {
            ...
            Some(f) => {
                f(project, nudgeflag, nudgewhat, nudgeunits, value, reverse, copies)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn CalculateNormalization(
        ...
        match self.pointers.CalculateNormalization {
            ...
            Some(f) => {
                f(source, normalizeTo, normalizeTarget, normalizeStart, normalizeEnd)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn EnumProjectMarkers(
        ...
        match self.pointers.EnumProjectMarkers {
            ...
            Some(f) => {
                f(idx, isrgnOut, posOut, rgnendOut, nameOut, markrgnindexnumberOut)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn EnumProjectMarkers2(
        ...
        match self.pointers.EnumProjectMarkers2 {
            ...
            Some(f) => {
                f(proj, idx, isrgnOut, posOut, rgnendOut, nameOut, markrgnindexnumberOut)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn GetEnvelopePoint(
        ...
        match self.pointers.GetEnvelopePoint {
            ...
            Some(f) => {
                f(envelope, ptidx, timeOut, valueOut, shapeOut, tensionOut, selectedOut)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn InsertEnvelopePoint(
        ...
        match self.pointers.InsertEnvelopePoint {
            ...
            Some(f) => {
                f(envelope, time, value, shape, tension, selected, noSortInOptional)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn LICE_ScaledBlit(
        ...
        match self.pointers.LICE_ScaledBlit {
            ...
            Some(f) => {
                f(dest, src, dstx, dsty, dstw, dsth, srcx, srcy, srcw, srch, alpha, mode)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn MIDI_GetEvt(
        ...
        match self.pointers.MIDI_GetEvt {
            ...
            Some(f) => {
                f(take, evtidx, selectedOut, mutedOut, ppqposOut, msgOut, msgOut_sz)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn MIDI_GetRecentInputEvent(
        ...
        match self.pointers.MIDI_GetRecentInputEvent {
            ...
            Some(f) => {
                f(idx, bufOut, bufOut_sz, tsOut, devIdxOut, projPosOut, projLoopCntOut)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn RenderFileSection(
        ...
        match self.pointers.RenderFileSection {
            ...
            Some(f) => {
                f(source_filename, target_filename, start_percent, end_percent, playrate)
            }
        }
    }
    ...
    pub unsafe fn SetProjectMarker4(
        ...
        match self.pointers.SetProjectMarker4 {
            ...
            Some(f) => {
                f(proj, markrgnindexnumber, isrgn, pos, rgnend, name, color, flags)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn SetProjectMarkerByIndex2(
        ...
        match self.pointers.SetProjectMarkerByIndex2 {
            ...
            Some(f) => {
                f(proj, markrgnidx, isrgn, pos, rgnend, IDnumber, name, color, flags)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn TakeFX_GetParameterStepSizes(
        ...
        match self.pointers.TakeFX_GetParameterStepSizes {
            ...
            Some(f) => {
                f(take, fx, param, stepOut, smallstepOut, largestepOut, istoggleOut)
            }
        }
    }
    /// # Safety
    ...
    pub unsafe fn TrackFX_GetParameterStepSizes(
        ...
        match self.pointers.TrackFX_GetParameterStepSizes {
            ...
            Some(f) => {
                f(track, fx, param, stepOut, smallstepOut, largestepOut, istoggleOut)
            }
        }
    }
    /// # Safety
...
pub struct ReaperFunctionPointers {
    ...
    pub CSurf_OnArrow: Option<
        extern "C" fn(whichdir: ::std::os::raw::c_int, wantzoom: bool),
    >,
    ...
    pub CSurf_OnRewFwd: Option<
        extern "C" fn(seekplay: ::std::os::raw::c_int, dir: ::std::os::raw::c_int),
    >,
    pub CSurf_OnScroll: Option<
        extern "C" fn(xdir: ::std::os::raw::c_int, ydir: ::std::os::raw::c_int),
    >,
    ...
    pub CSurf_OnTrackSelection: Option<
        unsafe extern "C" fn(trackid: *mut root::MediaTrack),
    >,
    ...
    pub CSurf_TrackFromID: Option<
        extern "C" fn(idx: ::std::os::raw::c_int, mcpView: bool) -> *mut root::MediaTrack,
    >,
    ...
    pub DockGetPosition: Option<
        extern "C" fn(whichDock: ::std::os::raw::c_int) -> ::std::os::raw::c_int,
    >,
    ...
    >,
    pub EnsureNotCompletelyOffscreen: Option<
        unsafe extern "C" fn(rInOut: *mut root::RECT),
    >,
    ...
    pub GetCursorContext2: Option<
        extern "C" fn(want_last_valid: bool) -> ::std::os::raw::c_int,
    >,
    pub GetCursorPosition: Option<extern "C" fn() -> f64>,
    pub GetCursorPositionEx: Option<
        unsafe extern "C" fn(proj: *mut root::ReaProject) -> f64,
    >,
    ...
    >,
    pub GetInputActivityLevel: Option<
        extern "C" fn(input_id: ::std::os::raw::c_int) -> f64,
    >,
    ...
    pub GetPlayPosition2Ex: Option<
        unsafe extern "C" fn(proj: *mut root::ReaProject) -> f64,
    >,
    pub GetPlayPositionEx: Option<
        unsafe extern "C" fn(proj: *mut root::ReaProject) -> f64,
    >,
    ...
    >,
    pub GetProjectTimeSignature: Option<
        unsafe extern "C" fn(bpmOut: *mut f64, bpiOut: *mut f64),
    >,
    ...
    pub GetToggleCommandState: Option<
        extern "C" fn(command_id: ::std::os::raw::c_int) -> ::std::os::raw::c_int,
    >,
    ...
    pub HasTrackMIDIPrograms: Option<
        extern "C" fn(track: ::std::os::raw::c_int) -> *const ::std::os::raw::c_char,
    >,
    ...
    >,
    pub IsMediaItemSelected: Option<
        unsafe extern "C" fn(item: *mut root::MediaItem) -> bool,
    >,
    pub IsProjectDirty: Option<
        unsafe extern "C" fn(proj: *mut root::ReaProject) -> ::std::os::raw::c_int,
    >,
    pub IsREAPER: Option<extern "C" fn() -> bool>,
    pub IsTrackSelected: Option<
        unsafe extern "C" fn(track: *mut root::MediaTrack) -> bool,
    >,
    ...
    >,
    pub LICE_CreateFont: Option<
        extern "C" fn() -> *mut root::reaper_functions::LICE_IFont,
    >,
    ...
    pub Main_OnCommand: Option<
        extern "C" fn(command: ::std::os::raw::c_int, flag: ::std::os::raw::c_int),
    >,
    ...
    >,
    pub Master_GetPlayRate: Option<
        unsafe extern "C" fn(project: *mut root::ReaProject) -> f64,
    >,
    ...
    pub Master_NormalizePlayRate: Option<
        extern "C" fn(playrate: f64, isnormalized: bool) -> f64,
    >,
    pub Master_NormalizeTempo: Option<
        extern "C" fn(bpm: f64, isnormalized: bool) -> f64,
    >,
    pub MB: Option<
        unsafe extern "C" fn(
            msg: *const ::std::os::raw::c_char,
    ...
    pub MIDI_eventlist_Destroy: Option<
        unsafe extern "C" fn(evtlist: *mut root::MIDI_eventlist),
    >,
    ...
    pub MIDIEditor_LastFocused_OnCommand: Option<
        extern "C" fn(command_id: ::std::os::raw::c_int, islistviewcommand: bool) -> bool,
    >,
    ...
    pub plugin_getImportableProjectFilterList: Option<
    ...
    pub ReaperGetPitchShiftAPI: Option<
        extern "C" fn(version: ::std::os::raw::c_int) -> *mut root::IReaperPitchShift,
    >,
    pub ReaScriptError: Option<
        unsafe extern "C" fn(errmsg: *const ::std::os::raw::c_char),
    >,
    ...
    pub Resample_EnumModes: Option<
        extern "C" fn(mode: ::std::os::raw::c_int) -> *const ::std::os::raw::c_char,
    >,
    pub Resampler_Create: Option<
        extern "C" fn() -> *mut root::REAPER_Resample_Interface,
    >,
    ...
    >,
    pub screenset_unregister: Option<
        unsafe extern "C" fn(id: *mut ::std::os::raw::c_char),
    >,
    pub screenset_unregisterByParam: Option<
    ...
    pub SectionFromUniqueID: Option<
        extern "C" fn(uniqueID: ::std::os::raw::c_int) -> *mut root::KbdSectionInfo,
    >,
    ...
    pub SetAutomationMode: Option<
        extern "C" fn(mode: ::std::os::raw::c_int, onlySel: bool),
    >,
    ...
    pub update_disk_counters: Option<
        extern "C" fn(readamt: ::std::os::raw::c_int, writeamt: ::std::os::raw::c_int),
    >,
    pub UpdateArrange: Option<extern "C" fn()>,
    pub UpdateItemInProject: Option<unsafe extern "C" fn(item: *mut root::MediaItem)>,
    pub UpdateItemLanes: Option<
        unsafe extern "C" fn(proj: *mut root::ReaProject) -> bool,
    >,
    ...
    >,
    pub InitializeCoolSB: Option<
        unsafe extern "system" fn(hwnd: root::HWND) -> root::BOOL,
    >,
    pub UninitializeCoolSB: Option<
        unsafe extern "system" fn(hwnd: root::HWND) -> root::HRESULT,
    >,
    ...
    pub CoolSB_SetResizingThumb: Option<
        unsafe extern "system" fn(hwnd: root::HWND, active: root::BOOL) -> root::BOOL,
    >,
