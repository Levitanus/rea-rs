...
pub mod root {
    ...
    pub const SW_SHOWMAXIMIZED: i32 = 4;
    pub const SW_RESTORE: i32 = 5;
    ...
    pub const PCM_SOURCE_EXT_GIVE_TRACK_HINT: i32 = 524298;
    ...
    pub const PCM_SOURCE_EXT_GET_LYRICS: i32 = 589888;
    pub const PCM_SOURCE_EXT_SET_LYRICS: i32 = 589889;
    pub const PCM_SOURCE_EXT_GETLAPPING: i32 = 786688;
    pub const PCM_SOURCE_EXT_SET_PREVIEW_POS_OVERRIDE: i32 = 786689;
    pub const PCM_SOURCE_EXT_SET_PREVIEW_LOOPCNT: i32 = 786690;
    pub const PCM_SOURCE_EXT_SET_IGNTEMPO: i32 = 786693;
    pub const PCM_SOURCE_EXT_GET_IGNTEMPO: i32 = 786694;
    ...
    pub const PCM_SINK_EXT_IS_DUMMY: i32 = 524297;
    pub const PCM_SINK_EXT_GIVE_TRACK_HINT: i32 = 524298;
    pub const RESAMPLE_EXT_SETRSMODE: i32 = 4096;
    pub const RESAMPLE_EXT_SETFEEDMODE: i32 = 4097;
    pub const RESAMPLE_EXT_PREALLOC: i32 = 4098;
    ...
    extern "C" {
        pub static mut SWELL_curmodule_dialogresource_head:
            *mut root::SWELL_DialogResourceIndex;
    }
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    ...
    extern "C" {
        pub static mut SWELL_curmodule_menuresource_head:
            *mut root::SWELL_MenuResourceIndex;
    }
    #[repr(C)]
    #[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
    ...
    pub const MIDI_event_t_CC_ALL_SOUND_OFF: root::MIDI_event_t__bindgen_ty_1 =
        120;
    pub const MIDI_event_t_CC_ALL_NOTES_OFF: root::MIDI_event_t__bindgen_ty_1 =
        123;
    pub const MIDI_event_t_CC_EOF_INDICATOR: root::MIDI_event_t__bindgen_ty_1 =
        123;
    ...
    pub struct _PCM_source_peaktransfer_t {
        ...
        pub extra_requested_data_type2: ::std::os::raw::c_int,
        pub extra_requested_data_out2: ::std::os::raw::c_int,
        pub extra_requested_data2: *mut ::std::os::raw::c_void,
        pub exp: [*mut ::std::os::raw::c_int; 25usize],
    }
    ...
    pub const _PCM_source_peaktransfer_t_PEAKTRANSFER_MIDI_DRUM_TRIANGLE_MODE : root :: _PCM_source_peaktransfer_t__bindgen_ty_1 = 4 ;
    ...
    pub const _PCM_source_peaktransfer_t_SPECTROGRAM2_BLOCKSIZE_BYTES:
        root::_PCM_source_peaktransfer_t__bindgen_ty_2 = 1536;
    pub const _PCM_source_peaktransfer_t_SPECTROGRAM_MAX_BLOCKSIZE_BYTES:
        root::_PCM_source_peaktransfer_t__bindgen_ty_2 = 1536;
    ...
    pub const _PCM_source_peaktransfer_t_LOUDNESS_INTERNAL_BYTES:
        root::_PCM_source_peaktransfer_t__bindgen_ty_2 = 4;
    ...
    pub type midi_realtime_write_struct_t =
        root::_REAPER_midi_realtime_write_struct_t;
    #[repr(C)]
    ...
    #[repr(C)]
    #[derive(Debug, Default, Copy, Clone, Hash, PartialEq, Eq)]
    pub struct _REAPER_pcmsrc_register_t {
        pub CreateFromType: ::std::option::Option<
            unsafe extern "C" fn(
                type_: *const ::std::os::raw::c_char,
                priority: ::std::os::raw::c_int,
            ) -> *mut root::PCM_source,
        >,
        pub CreateFromFile: ::std::option::Option<
            unsafe extern "C" fn(
        ...
        pub EnumFileExtensions: ::std::option::Option<
            unsafe extern "C" fn(
                i: ::std::os::raw::c_int,
                descptr: *mut *const ::std::os::raw::c_char,
            ) -> *const ::std::os::raw::c_char,
        >,
    }
    pub type pcmsrc_register_t = root::_REAPER_pcmsrc_register_t;
    #[repr(C)]
    ...
    #[repr(C)]
    #[derive(Debug, Default, Copy, Clone, Hash, PartialEq, Eq)]
    pub struct _REAPER_pcmsink_register_t {
        pub GetFmt: ::std::option::Option<
            unsafe extern "C" fn(
        ...
        pub GetExtension: ::std::option::Option<
            unsafe extern "C" fn(
                cfg: *const ::std::os::raw::c_void,
                cfg_l: ::std::os::raw::c_int,
            ) -> *const ::std::os::raw::c_char,
        >,
        ...
        >,
        pub CreateSink: ::std::option::Option<
            unsafe extern "C" fn(
                filename: *const ::std::os::raw::c_char,
    ...
    pub type pcmsink_register_t = root::_REAPER_pcmsink_register_t;
    #[repr(C)]
    pub struct REAPER_Resample_Interface__bindgen_vtable(
        ::std::os::raw::c_void,
    );
    ...
    #[repr(C)]
    #[derive(Debug, Default, Copy, Clone, Hash, PartialEq, Eq)]
    pub struct _REAPER_editor_register_t {
        pub editFile: ::std::option::Option<
            unsafe extern "C" fn(
                filename: *const ::std::os::raw::c_char,
                parent: root::HWND,
        ...
        >,
        pub wouldHandle: ::std::option::Option<
            unsafe extern "C" fn(
                filename: *const ::std::os::raw::c_char,
            ) -> *const ::std::os::raw::c_char,
        >,
    }
    pub type editor_register_t = root::_REAPER_editor_register_t;
    #[repr(C)]
    #[derive(Debug, Default, Copy, Clone, Hash, PartialEq, Eq)]
    pub struct _REAPER_project_import_register_t {
    ...
    pub type project_import_register_t =
        root::_REAPER_project_import_register_t;
    #[repr(C)]
    #[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
    pub struct project_config_extension_t {
        pub ProcessExtensionLine: ::std::option::Option<
            unsafe extern "C" fn(
                ...
                isUndo: bool,
                reg: *mut root::project_config_extension_t,
            ) -> bool,
        >,
        ...
        >,
        pub BeginLoadProjectState: ::std::option::Option<
            unsafe extern "C" fn(
                isUndo: bool,
                reg: *mut root::project_config_extension_t,
            ),
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
    pub struct prefs_page_register_t {
        pub idstr: *const ::std::os::raw::c_char,
        pub displayname: *const ::std::os::raw::c_char,
        pub create: ::std::option::Option<
            unsafe extern "C" fn(par: root::HWND) -> root::HWND,
        >,
        pub par_id: ::std::os::raw::c_int,
        pub par_idstr: *const ::std::os::raw::c_char,
        pub childrenFlag: ::std::os::raw::c_int,
        pub treeitem: *mut ::std::os::raw::c_void,
        pub hwndCache: root::HWND,
        pub _extra: [::std::os::raw::c_char; 64usize],
    }
    impl Default for prefs_page_register_t {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    pub mod reaper_functions {
        ...
        extern "C" {
            ...
            pub static mut AnyTrackSolo: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut BypassFxAllTracks: ::std::option::Option<
                unsafe extern "C" fn(bypass: ::std::os::raw::c_int),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            # [link_name = "\u{1}_ZN16reaper_functions23CreateTakeAudioAccessorE"] pub static mut CreateTakeAudioAccessor : :: std :: option :: Option < unsafe extern "C" fn (take : * mut root :: MediaItem_Take) -> * mut root :: reaper_functions :: AudioAccessor > ;
        }
        extern "C" {
            # [link_name = "\u{1}_ZN16reaper_functions24CreateTrackAudioAccessorE"] pub static mut CreateTrackAudioAccessor : :: std :: option :: Option < unsafe extern "C" fn (track : * mut root :: MediaTrack) -> * mut root :: reaper_functions :: AudioAccessor > ;
        }
        extern "C" {
        ...
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions25CrossfadeEditor_OnCommandE"]
            pub static mut CrossfadeEditor_OnCommand: ::std::option::Option<
                unsafe extern "C" fn(command: ::std::os::raw::c_int),
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions20CrossfadeEditor_ShowE"]
            pub static mut CrossfadeEditor_Show:
        ...
        extern "C" {
            ...
            pub static mut CSurf_GoEnd:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions13CSurf_GoStartE"]
            pub static mut CSurf_GoStart:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions15CSurf_NumTracksE"]
            pub static mut CSurf_NumTracks: ::std::option::Option<
                unsafe extern "C" fn(mcpView: bool) -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut CSurf_OnFwd: ::std::option::Option<
                unsafe extern "C" fn(seekplay: ::std::os::raw::c_int),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut CSurf_OnPause:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions12CSurf_OnPlayE"]
            pub static mut CSurf_OnPlay:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut CSurf_OnRew: ::std::option::Option<
                unsafe extern "C" fn(seekplay: ::std::os::raw::c_int),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut CSurf_OnTrackSelection: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut CSurf_ScrubAmt:
                ::std::option::Option<unsafe extern "C" fn(amt: f64)>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut CSurf_SetTrackListChange:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut DB2SLIDER:
                ::std::option::Option<unsafe extern "C" fn(x: f64) -> f64>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut DeleteTrack: ::std::option::Option<
                unsafe extern "C" fn(tr: *mut root::MediaTrack),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut DockWindowRefresh:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut EnsureNotCompletelyOffscreen: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut FreeHeapPtr: ::std::option::Option<
                unsafe extern "C" fn(ptr: *mut ::std::os::raw::c_void),
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions7genGuidE"]
            pub static mut genGuid: ::std::option::Option<
                unsafe extern "C" fn(g: *mut root::GUID),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut get_ini_file: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut GetAppVersion: ::std::option::Option<
                unsafe extern "C" fn() -> *const ::std::os::raw::c_char,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetCurrentProjectInLoadSave: ::std::option::Option<
                unsafe extern "C" fn() -> *mut root::ReaProject,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions16GetCursorContextE"]
            pub static mut GetCursorContext: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetExePath: ::std::option::Option<
                unsafe extern "C" fn() -> *const ::std::os::raw::c_char,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetFreeDiskSpaceForRecordPath:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        proj: *mut root::ReaProject,
        ...
        extern "C" {
            ...
            pub static mut GetGlobalAutomationOverride: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions13GetHZoomLevelE"]
            pub static mut GetHZoomLevel:
                ::std::option::Option<unsafe extern "C" fn() -> f64>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetInputActivityLevel: ::std::option::Option<
                unsafe extern "C" fn(input_id: ::std::os::raw::c_int) -> f64,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetLastColorThemeFile: ::std::option::Option<
                unsafe extern "C" fn() -> *const ::std::os::raw::c_char,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetLastTouchedTrack: ::std::option::Option<
                unsafe extern "C" fn() -> *mut root::MediaTrack,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions11GetMainHwndE"]
            pub static mut GetMainHwnd:
                ::std::option::Option<unsafe extern "C" fn() -> root::HWND>;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions22GetMasterMuteSoloFlagsE"]
            pub static mut GetMasterMuteSoloFlags: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetMasterTrackVisibility: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions16GetMaxMidiInputsE"]
            pub static mut GetMaxMidiInputs: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions17GetMaxMidiOutputsE"]
            pub static mut GetMaxMidiOutputs: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions23GetMIDIInputNameNoAliasE"]
            pub static mut GetMIDIInputNameNoAlias: ::std::option::Option<
                unsafe extern "C" fn(
                    dev: ::std::os::raw::c_int,
                    nameout: *mut ::std::os::raw::c_char,
                    nameout_sz: ::std::os::raw::c_int,
        ...
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions24GetMIDIOutputNameNoAliasE"]
            pub static mut GetMIDIOutputNameNoAlias: ::std::option::Option<
                unsafe extern "C" fn(
                    dev: ::std::os::raw::c_int,
                    nameout: *mut ::std::os::raw::c_char,
                    nameout_sz: ::std::os::raw::c_int,
        ...
        extern "C" {
            ...
            pub static mut GetMixerScroll: ::std::option::Option<
                unsafe extern "C" fn() -> *mut root::MediaTrack,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetNumAudioInputs: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions18GetNumAudioOutputsE"]
            pub static mut GetNumAudioOutputs: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions16GetNumMIDIInputsE"]
            pub static mut GetNumMIDIInputs: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions17GetNumMIDIOutputsE"]
            pub static mut GetNumMIDIOutputs: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetNumTracks: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions5GetOSE"]
            pub static mut GetOS: ::std::option::Option<
                unsafe extern "C" fn() -> *const ::std::os::raw::c_char,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetOutputLatency:
                ::std::option::Option<unsafe extern "C" fn() -> f64>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetProjectLength: ::std::option::Option<
                unsafe extern "C" fn(proj: *mut root::ReaProject) -> f64,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetProjectTimeSignature: ::std::option::Option<
        ...
        extern "C" {
            # [link_name = "\u{1}_ZN16reaper_functions17GetRegionOrMarkerE"] pub static mut GetRegionOrMarker : :: std :: option :: Option < unsafe extern "C" fn (proj : * mut root :: ReaProject , index : :: std :: os :: raw :: c_int , guidStr : * const :: std :: os :: raw :: c_char) -> * mut root :: reaper_functions :: ProjectMarker > ;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions27GetRegionOrMarkerInfo_ValueE"]
        ...
        extern "C" {
            ...
            pub static mut GetResourcePath: ::std::option::Option<
                unsafe extern "C" fn() -> *const ::std::os::raw::c_char,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetSetAutomationItemInfo_String:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        env: *mut root::TrackEnvelope,
                        autoitem_idx: ::std::os::raw::c_int,
        ...
        extern "C" {
            ...
            pub static mut GetSetMediaItemTakeInfo_String:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        tk: *mut root::MediaItem_Take,
                        parmname: *const ::std::os::raw::c_char,
        ...
        extern "C" {
            # [link_name = "\u{1}_ZN16reaper_functions31GetSetRegionOrMarkerInfo_StringE"] pub static mut GetSetRegionOrMarkerInfo_String : :: std :: option :: Option < unsafe extern "C" fn (proj : * mut root :: ReaProject , regionOrMarker : * mut root :: reaper_functions :: ProjectMarker , parameterName : * const :: std :: os :: raw :: c_char , stringNeedBig : * mut :: std :: os :: raw :: c_char , setNewValue : bool) -> bool > ;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut GetSetTrackGroupMembershipHigh:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        tr: *mut root::MediaTrack,
                        groupname: *const ::std::os::raw::c_char,
        ...
        extern "C" {
            ...
            pub static mut GetToggleCommandStateThroughHooks:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        section: *mut root::KbdSectionInfo,
                        command_id: ::std::os::raw::c_int,
        ...
        extern "C" {
            ...
            pub static mut IsInRealTimeAudio: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut IsMediaItemSelected: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut IsREAPER:
                ::std::option::Option<unsafe extern "C" fn() -> bool>;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions15IsTrackSelectedE"]
            pub static mut IsTrackSelected: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut IsWindowTextField: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND) -> bool,
            >;
        }
        extern "C" {
            # [link_name = "\u{1}_ZN16reaper_functions15joystick_createE"] pub static mut joystick_create : :: std :: option :: Option < unsafe extern "C" fn (guid : * const root :: GUID) -> * mut root :: reaper_functions :: joystick_device > ;
        }
        extern "C" {
        ...
        extern "C" {
            # [link_name = "\u{1}_ZN16reaper_functions17LICE_CreateBitmapE"] pub static mut LICE_CreateBitmap : :: std :: option :: Option < unsafe extern "C" fn (mode : :: std :: os :: raw :: c_int , w : :: std :: os :: raw :: c_int , h : :: std :: os :: raw :: c_int) -> * mut root :: reaper_functions :: LICE_IBitmap > ;
        }
        extern "C" {
            # [link_name = "\u{1}_ZN16reaper_functions15LICE_CreateFontE"] pub static mut LICE_CreateFont : :: std :: option :: Option < unsafe extern "C" fn () -> * mut root :: reaper_functions :: LICE_IFont > ;
        }
        extern "C" {
        ...
        extern "C" {
            # [link_name = "\u{1}_ZN16reaper_functions12LICE_LoadPNGE"] pub static mut LICE_LoadPNG : :: std :: option :: Option < unsafe extern "C" fn (filename : * const :: std :: os :: raw :: c_char , bmp : * mut root :: reaper_functions :: LICE_IBitmap) -> * mut root :: reaper_functions :: LICE_IBitmap > ;
        }
        extern "C" {
            # [link_name = "\u{1}_ZN16reaper_functions24LICE_LoadPNGFromResourceE"] pub static mut LICE_LoadPNGFromResource : :: std :: option :: Option < unsafe extern "C" fn (hInst : root :: HINSTANCE , resid : * const :: std :: os :: raw :: c_char , bmp : * mut root :: reaper_functions :: LICE_IBitmap) -> * mut root :: reaper_functions :: LICE_IBitmap > ;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut Main_openProject: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut Main_UpdateLoopInfo: ::std::option::Option<
                unsafe extern "C" fn(ignoremask: ::std::os::raw::c_int),
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions16MarkProjectDirtyE"]
            pub static mut MarkProjectDirty: ::std::option::Option<
                unsafe extern "C" fn(proj: *mut root::ReaProject),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut Master_GetPlayRate: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut Master_GetTempo:
                ::std::option::Option<unsafe extern "C" fn() -> f64>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut Master_NormalizeTempo: ::std::option::Option<
                unsafe extern "C" fn(bpm: f64, isnormalized: bool) -> f64,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions34MediaExplorerGetLastPlayedFileInfoE"]
            pub static mut MediaExplorerGetLastPlayedFileInfo:
                ::std::option::Option<
                    unsafe extern "C" fn(
        ...
        extern "C" {
            ...
            pub static mut MIDI_DisableSort: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut MIDI_eventlist_Create: ::std::option::Option<
                unsafe extern "C" fn() -> *mut root::MIDI_eventlist,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions22MIDI_eventlist_DestroyE"]
            pub static mut MIDI_eventlist_Destroy: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut MIDI_GetPPQPos_StartOfMeasure:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        take: *mut root::MediaItem_Take,
                        ppqpos: f64,
        ...
        extern "C" {
            ...
            pub static mut MIDI_RefreshEditors: ::std::option::Option<
                unsafe extern "C" fn(tk: *mut root::MediaItem_Take),
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions11midi_reinitE"]
            pub static mut midi_reinit:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut MIDI_Sort: ::std::option::Option<
                unsafe extern "C" fn(take: *mut root::MediaItem_Take),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut MIDIEditor_LastFocused_OnCommand:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        command_id: ::std::os::raw::c_int,
        ...
        extern "C" {
            ...
            pub static mut MoveEditCursor: ::std::option::Option<
                unsafe extern "C" fn(adjamt: f64, dosel: bool),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut MuteAllTracks:
                ::std::option::Option<unsafe extern "C" fn(mute: bool)>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut PCM_Source_Destroy: ::std::option::Option<
                unsafe extern "C" fn(src: *mut root::PCM_source),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut plugin_getFilterList: ::std::option::Option<
                unsafe extern "C" fn() -> *const ::std::os::raw::c_char,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut PluginWantsAlwaysRunFx: ::std::option::Option<
                unsafe extern "C" fn(amt: ::std::os::raw::c_int),
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions16PreventUIRefreshE"]
            pub static mut PreventUIRefresh: ::std::option::Option<
                unsafe extern "C" fn(prevent_count: ::std::os::raw::c_int),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut realloc_cmd_clear: ::std::option::Option<
                unsafe extern "C" fn(tok: ::std::os::raw::c_int),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut ReaScriptError: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut RefreshToolbar: ::std::option::Option<
                unsafe extern "C" fn(command_id: ::std::os::raw::c_int),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions16ResolveWildcardsE"]
            pub static mut ResolveWildcards: ::std::option::Option<
                unsafe extern "C" fn(
                    project: *mut root::ReaProject,
                    timePosition: f64,
        ...
        extern "C" {
            ...
            pub static mut SelectProjectInstance: ::std::option::Option<
                unsafe extern "C" fn(proj: *mut root::ReaProject),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut SetGlobalAutomationOverride: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut SetOnlyTrackSelected: ::std::option::Option<
                unsafe extern "C" fn(track: *mut root::MediaTrack),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions27SetRegionOrMarkerInfo_ValueE"]
        ...
        extern "C" {
            ...
            pub static mut ShowConsoleMsg: ::std::option::Option<
        ...
        extern "C" {
            ...
            pub static mut SLIDER2DB:
                ::std::option::Option<unsafe extern "C" fn(y: f64) -> f64>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut SoloAllTracks: ::std::option::Option<
                unsafe extern "C" fn(solo: ::std::os::raw::c_int),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions16StartPreviewFadeE"]
            pub static mut StartPreviewFade: ::std::option::Option<
                unsafe extern "C" fn(
                    project: *mut root::ReaProject,
                    preview: *mut root::preview_register_t,
                    fadelen: f64,
        ...
        extern "C" {
            ...
            pub static mut TakeFX_FormatParamValueNormalized:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        take: *mut root::MediaItem_Take,
                        fx: ::std::os::raw::c_int,
        ...
        extern "C" {
            ...
            pub static mut TakeFX_GetFormattedParamValue:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        take: *mut root::MediaItem_Take,
                        fx: ::std::os::raw::c_int,
        ...
        extern "C" {
            ...
            pub static mut ThemeLayout_RefreshAll:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut TrackFX_FormatParamValueNormalized:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        track: *mut root::MediaTrack,
                        fx: ::std::os::raw::c_int,
        ...
        extern "C" {
            ...
            pub static mut TrackFX_GetFormattedParamValue:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        track: *mut root::MediaTrack,
                        fx: ::std::os::raw::c_int,
        ...
        extern "C" {
            ...
            pub static mut TrackFX_GetParameterStepSizes:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        track: *mut root::MediaTrack,
                        fx: ::std::os::raw::c_int,
        ...
        extern "C" {
            ...
            pub static mut TrackFX_GetUserPresetFilename:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        track: *mut root::MediaTrack,
                        fx: ::std::os::raw::c_int,
        ...
        extern "C" {
            ...
            pub static mut Undo_BeginBlock:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions16Undo_BeginBlock2E"]
            pub static mut Undo_BeginBlock2: ::std::option::Option<
                unsafe extern "C" fn(proj: *mut root::ReaProject),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut UpdateArrange:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions19UpdateItemInProjectE"]
            pub static mut UpdateItemInProject: ::std::option::Option<
                unsafe extern "C" fn(item: *mut root::MediaItem),
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions15UpdateItemLanesE"]
            pub static mut UpdateItemLanes: ::std::option::Option<
                unsafe extern "C" fn(proj: *mut root::ReaProject) -> bool,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions14UpdateTimelineE"]
            pub static mut UpdateTimeline:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
        ...
        extern "C" {
            ...
            pub static mut InitializeCoolSB: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND) -> root::BOOL,
            >;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN16reaper_functions18UninitializeCoolSBE"]
            pub static mut UninitializeCoolSB: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND) -> root::HRESULT,
            >;
        }
        extern "C" {
    ...
    pub mod swell_functions {
        ...
        extern "C" {
            pub static mut Sleep: ::std::option::Option<
                unsafe extern "C" fn(ms: ::std::os::raw::c_int),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SetFocus:
                ::std::option::Option<unsafe extern "C" fn(hwnd: root::HWND)>;
        }
        extern "C" {
            pub static mut GetFocus:
                ::std::option::Option<unsafe extern "C" fn() -> root::HWND>;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SetCapture: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND) -> root::HWND,
            >;
        }
        extern "C" {
            pub static mut GetCapture:
                ::std::option::Option<unsafe extern "C" fn() -> root::HWND>;
        }
        extern "C" {
            pub static mut ReleaseCapture:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut GetParent: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND) -> root::HWND,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut ClientToScreen: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND, p: *mut root::POINT),
            >;
        }
        extern "C" {
            pub static mut ScreenToClient: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND, p: *mut root::POINT),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut GetWindowContentViewRect: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND, r: *mut root::RECT),
            >;
        }
        extern "C" {
            pub static mut GetClientRect: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND, r: *mut root::RECT),
            >;
        }
        extern "C" {
            pub static mut WindowFromPoint: ::std::option::Option<
                unsafe extern "C" fn(p: root::POINT) -> root::HWND,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut IsWindowVisible: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND) -> bool,
            >;
        }
        extern "C" {
            pub static mut IsWindow: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND) -> bool,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut ListView_SetExtendedListViewStyleEx:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        h: root::HWND,
        ...
        extern "C" {
            pub static mut ListView_GetColumn: ::std::option::Option<
                unsafe extern "C" fn(
                    h: root::HWND,
                    pos: ::std::os::raw::c_int,
        ...
        extern "C" {
            pub static mut ListView_GetSelectedCount: ::std::option::Option<
                unsafe extern "C" fn(h: root::HWND) -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
            pub static mut ListView_GetItemCount: ::std::option::Option<
                unsafe extern "C" fn(h: root::HWND) -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
            pub static mut ListView_GetSelectionMark: ::std::option::Option<
                unsafe extern "C" fn(h: root::HWND) -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut ListView_GetTopIndex: ::std::option::Option<
                unsafe extern "C" fn(h: root::HWND) -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
            pub static mut ListView_GetCountPerPage: ::std::option::Option<
                unsafe extern "C" fn(h: root::HWND) -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut ListView_GetHeader: ::std::option::Option<
                unsafe extern "C" fn(h: root::HWND) -> root::HWND,
            >;
        }
        extern "C" {
            pub static mut Header_GetItemCount: ::std::option::Option<
                unsafe extern "C" fn(h: root::HWND) -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut ImageList_CreateEx: ::std::option::Option<
                unsafe extern "C" fn() -> root::HIMAGELIST,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut ImageList_Destroy: ::std::option::Option<
                unsafe extern "C" fn(arg1: root::HIMAGELIST),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut TreeView_GetSelection: ::std::option::Option<
        ...
        extern "C" {
            pub static mut TreeView_GetRoot: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND) -> root::HTREEITEM,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SWELL_ModalWindowEnd: ::std::option::Option<
        ...
        extern "C" {
            pub static mut DestroyMenu: ::std::option::Option<
                unsafe extern "C" fn(hMenu: root::HMENU),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SWELL_SetMenuDestination: ::std::option::Option<
                unsafe extern "C" fn(menu: root::HMENU, hwnd: root::HWND),
            >;
        }
        extern "C" {
            pub static mut SWELL_DuplicateMenu: ::std::option::Option<
        ...
        extern "C" {
            pub static mut GetMenu: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND) -> root::HMENU,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SWELL_MessageQueue_Flush:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut GetCursorPos: ::std::option::Option<
                unsafe extern "C" fn(pt: *mut root::POINT),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SWELL_SetCursor: ::std::option::Option<
                unsafe extern "C" fn(curs: root::HCURSOR),
            >;
        }
        extern "C" {
            pub static mut SWELL_EnableRightClickEmulate:
                ::std::option::Option<
                    unsafe extern "C" fn(enable: root::BOOL),
                >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut OpenClipboard: ::std::option::Option<
                unsafe extern "C" fn(hwndDlg: root::HWND) -> bool,
            >;
        }
        extern "C" {
            pub static mut CloseClipboard:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
            pub static mut GetClipboardData: ::std::option::Option<
                unsafe extern "C" fn(type_: root::UINT) -> root::HANDLE,
            >;
        }
        extern "C" {
            pub static mut EmptyClipboard:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
            pub static mut SetClipboardData: ::std::option::Option<
        ...
        extern "C" {
            pub static mut EnumClipboardFormats: ::std::option::Option<
        ...
        extern "C" {
            pub static mut CloseHandle: ::std::option::Option<
                unsafe extern "C" fn(hand: root::HANDLE) -> root::BOOL,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SetEvent: ::std::option::Option<
                unsafe extern "C" fn(evt: root::HANDLE) -> root::BOOL,
            >;
        }
        extern "C" {
            pub static mut ResetEvent: ::std::option::Option<
                unsafe extern "C" fn(evt: root::HANDLE) -> root::BOOL,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut FreeLibrary: ::std::option::Option<
                unsafe extern "C" fn(hInst: root::HINSTANCE) -> root::BOOL,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SWELL_SetClipRegion: ::std::option::Option<
        ...
        extern "C" {
            pub static mut DeleteObject: ::std::option::Option<
                unsafe extern "C" fn(arg1: root::HGDIOBJ),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SWELL_GetScaling256: ::std::option::Option<
                unsafe extern "C" fn() -> ::std::os::raw::c_int,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SetOpaque: ::std::option::Option<
                unsafe extern "C" fn(h: root::HWND, isopaque: bool),
            >;
        }
        extern "C" {
            pub static mut SetAllowNoMiddleManRendering: ::std::option::Option<
        ...
        extern "C" {
            pub static mut SWELL_SetViewGL: ::std::option::Option<
                unsafe extern "C" fn(
                    h: root::HWND,
                    wantGL: ::std::os::raw::c_char,
                ),
            >;
        }
        extern "C" {
            pub static mut SWELL_GetViewGL: ::std::option::Option<
                unsafe extern "C" fn(h: root::HWND) -> bool,
            >;
        }
        extern "C" {
            pub static mut SWELL_SetGLContextToView: ::std::option::Option<
                unsafe extern "C" fn(h: root::HWND) -> bool,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut GetDC: ::std::option::Option<
                unsafe extern "C" fn(arg1: root::HWND) -> root::HDC,
            >;
        }
        extern "C" {
            pub static mut GetWindowDC: ::std::option::Option<
                unsafe extern "C" fn(arg1: root::HWND) -> root::HDC,
            >;
        }
        extern "C" {
            pub static mut ReleaseDC: ::std::option::Option<
                unsafe extern "C" fn(arg1: root::HWND, arg2: root::HDC),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SWELL_CloneGDIObject: ::std::option::Option<
            ...
            pub static mut SWELL_InitiateDragDrop: ::std::option::Option<
                unsafe extern "C" fn(
                    ...
                    callback: ::std::option::Option<
                        unsafe extern "C" fn(
                            droppath: *const ::std::os::raw::c_char,
                        ),
                    >,
                ),
            >;
        ...
        extern "C" {
            pub static mut SWELL_InitiateDragDropOfFileList:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        arg1: root::HWND,
                        srcrect: *mut root::RECT,
        ...
        extern "C" {
            pub static mut SWELL_FinishDragDrop:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SWELL_SetListViewFastClickMask:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        hList: root::HWND,
                        mask: ::std::os::raw::c_int,
        ...
        extern "C" {
            pub static mut SWELL_RunMessageLoop:
                ::std::option::Option<unsafe extern "C" fn()>;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SWELL_GenerateGUID: ::std::option::Option<
        ...
        extern "C" {
            pub static mut SWELL_IsGroupBox: ::std::option::Option<
                unsafe extern "C" fn(arg1: root::HWND) -> root::BOOL,
            >;
        }
        extern "C" {
            pub static mut SWELL_IsButton: ::std::option::Option<
                unsafe extern "C" fn(arg1: root::HWND) -> root::BOOL,
            >;
        }
        extern "C" {
            pub static mut SWELL_IsStaticText: ::std::option::Option<
                unsafe extern "C" fn(arg1: root::HWND) -> root::BOOL,
            >;
        }
        extern "C" {
            pub static mut SWELL_GetDesiredControlSize: ::std::option::Option<
                unsafe extern "C" fn(hwnd: root::HWND, r: *mut root::RECT),
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SWELL_Register_Cursor_Resource:
                ::std::option::Option<
                    unsafe extern "C" fn(
                        idx: *const ::std::os::raw::c_char,
                        name: *const ::std::os::raw::c_char,
        ...
        extern "C" {
            pub static mut IsWindowEnabled: ::std::option::Option<
                unsafe extern "C" fn(arg1: root::HWND) -> bool,
            >;
        }
        extern "C" {
        ...
        extern "C" {
            pub static mut SWELL_DisableContextMenu: ::std::option::Option<
        ...
        extern "C" {
            pub static mut SWELL_osx_is_dark_mode: ::std::option::Option<
                unsafe extern "C" fn(mode: ::std::os::raw::c_int) -> bool,
            >;
        }
    }
    pub mod reaper_control_surface {
        ...
        extern "C" {
            pub fn delete_control_surface(
                surface: *mut root::IReaperControlSurface,
            );
        }
        extern "C" {
    ...
    pub mod reaper_midi {
        ...
        extern "C" {
            pub fn midi_Input_GetReadBuf(
                self_: *mut root::midi_Input,
    ...
    pub mod reaper_pcm_source {
        ...
        extern "C" {
            pub fn rust_to_cpp_PCM_source_GetLength(
        ...
        extern "C" {
            pub fn rust_to_cpp_PCM_source_IsAvailable(
                self_: *mut root::PCM_source,
            ) -> bool;
        }
        extern "C" {
            pub fn rust_to_cpp_PCM_source_SetAvailable(
                self_: *mut root::PCM_source,
                avail: bool,
            );
        }
        ...
        extern "C" {
            pub fn rust_to_cpp_PCM_source_GetSampleRate(
                self_: *mut root::PCM_source,
            ) -> f64;
        }
        extern "C" {
            pub fn rust_to_cpp_PCM_source_GetLengthBeats(
                self_: *mut root::PCM_source,
            ) -> f64;
        }
        extern "C" {
        ...
        extern "C" {
            pub fn rust_to_cpp_PCM_source_GetPreferredPosition(
                self_: *mut root::PCM_source,
            ) -> f64;
        }
        extern "C" {
        ...
        extern "C" {
            pub fn rust_to_cpp_PCM_source_PeaksBuild_Finish(
                self_: *mut root::PCM_source,
            );
        }
        extern "C" {
    ...
    pub mod reaper_pcm_sink {
        ...
        extern "C" {
            pub fn rust_to_cpp_PCM_sink_GetStartTime(
                self_: *mut root::PCM_sink,
            ) -> f64;
        }
        extern "C" {
            pub fn rust_to_cpp_PCM_sink_SetStartTime(
                self_: *mut root::PCM_sink,
                st: f64,
            );
        }
        ...
        extern "C" {
            pub fn rust_to_cpp_PCM_sink_GetLength(
                self_: *mut root::PCM_sink,
            ) -> f64;
        }
        extern "C" {
        ...
        extern "C" {
            pub fn rust_to_cpp_PCM_sink_WantMIDI(
                self_: *mut root::PCM_sink,
            ) -> bool;
        }
        extern "C" {
    ...
    pub mod reaper_resample {
        ...
        extern "C" {
            pub fn REAPER_Resample_Interface_Reset(
                self_: *mut root::REAPER_Resample_Interface,
            );
        }
        extern "C" {
    ...
    pub mod reaper_pitch_shift {
        ...
        use self::super::super::root;
        extern "C" {
            pub fn delete_reaper_pitch_shift(
                pitch_shift: *mut root::IReaperPitchShift,
            );
        }
        extern "C" {
            pub fn IReaperPitchShift_set_srate(
        ...
        extern "C" {
            pub fn IReaperPitchShift_set_shift(
                self_: *mut root::IReaperPitchShift,
                shift: f64,
            );
        }
        ...
        extern "C" {
            pub fn IReaperPitchShift_set_tempo(
                self_: *mut root::IReaperPitchShift,
                tempo: f64,
            );
        }
        extern "C" {
            pub fn IReaperPitchShift_Reset(
                self_: *mut root::IReaperPitchShift,
            );
        }
        extern "C" {
        ...
        extern "C" {
            pub fn IReaperPitchShift_FlushSamples(
                self_: *mut root::IReaperPitchShift,
            );
        }
        extern "C" {
            pub fn IReaperPitchShift_IsReset(
                self_: *mut root::IReaperPitchShift,
            ) -> bool;
        }
        extern "C" {
    ...
    pub mod reaper_project_state_context {
        ...
        extern "C" {
            pub fn delete_project_state_context(
                context: *mut root::ProjectStateContext,
            );
        }
        extern "C" {
