...
impl raw::ProjectStateContext {
    /// Attention: Not really usable yet due to the lack of the variadic
    /// parameter in AddLine.
    ///
    /// # Safety
    ///
    ...
    pub unsafe fn GetLine(
        ...
        rust_to_cpp_ProjectStateContext_GetLine(
    ...
    pub fn GetOutputSize(&mut self) -> ::std::os::raw::c_longlong {
        unsafe {
            rust_to_cpp_ProjectStateContext_GetOutputSize(
                self as *const _ as _,
            )
        }
    }
    ...
    pub fn GetTempFlag(&mut self) -> ::std::os::raw::c_int {
        unsafe {
            rust_to_cpp_ProjectStateContext_GetTempFlag(self as *const _ as _)
        }
    }

    pub fn SetTempFlag(&mut self, flag: ::std::os::raw::c_int) {
        unsafe {
            rust_to_cpp_ProjectStateContext_SetTempFlag(
                self as *const _ as _,
                flag,
            )
        }
...
///
/// Attention: Not really usable yet due to the lack of the variadic parameter
/// in AddLine.
///
...
/// Creates a `ProjectStateContext` object on C++ side and returns a pointer to
/// it.
///
...
/// counterpart ProjectStateContext by calling
...
pub unsafe fn delete_cpp_project_state_context(
    context: NonNull<raw::ProjectStateContext>,
) {
...
extern "C" fn cpp_to_rust_ProjectStateContext_GetLine(
    ...
    firewall(|| unsafe { &mut *callback_target }.GetLine(buf, buflen))
        .unwrap_or_default()
}
...
extern "C" fn cpp_to_rust_ProjectStateContext_GetOutputSize(
    ...
    firewall(|| unsafe { &mut *callback_target }.GetOutputSize())
        .unwrap_or_default()
}
...
extern "C" fn cpp_to_rust_ProjectStateContext_GetTempFlag(
    ...
    firewall(|| unsafe { &mut *callback_target }.GetTempFlag())
        .unwrap_or_default()
}
